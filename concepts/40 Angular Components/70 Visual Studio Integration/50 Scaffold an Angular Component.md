...
1. In **Solution Explorer**, right-click a folder. In the invoked menu, point to **Add** and then click **New Scaffolded Item...**.
    ...
    ![DevExtreme Angular Component Scaffolding - Add New Scaffolded Item on the context menu](/Content/images/doc/19_2/AngularComponentScaffolding/ng-scaffolding-add-new-item.png)

2. In the **Add Scaffold** window, choose **Angular Component with a DevExtreme UI Widget** and click **Add**.

    ![DevExtreme Angular Component Scaffolding - The Add Scaffold window](/Content/images/doc/19_2/AngularComponentScaffolding/ng-scaffolding-add-scaffold.png)
...
3. In the wizard, enter the component's name, choose the DevExtreme widget to scaffold, and configure data binding and related settings. Click **Add** to finish the scaffolding.
    ...
    ![DevExtreme Angular Component Scaffolding - The Add Angular Component window](/Content/images/doc/19_2/AngularComponentScaffolding/ng-scaffolding-add-component.png)
