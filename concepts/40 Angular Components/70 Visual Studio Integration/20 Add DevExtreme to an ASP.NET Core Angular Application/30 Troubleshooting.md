...
In ASP.NET Core, property names are converted to lowerCamelCase during serialization to JSON. If [column data fields](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/columns/#dataField) use the UpperCamelCase, then error E1046 occurs.
