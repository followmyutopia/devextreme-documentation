...
To focus the **Bill Total** field when the view is shown, handle the scope's [$routeChangeSuccess](http://docs.angularjs.org/api/ngRoute.$route#$routeChangeSuccess) event.
