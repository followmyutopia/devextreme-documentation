Use nested configuration components. In the following example, we configure the [Chart](http://js.devexpress.com/Demos/WidgetsGallery/Demo/Charts/Overview/Vue/Light/) widget's [tooltip](/api-reference/20%20Data%20Visualization%20Widgets/dxChart/1%20Configuration/tooltip/tooltip.md '/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Configuration/tooltip/') option:
