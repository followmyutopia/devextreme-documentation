...
If you use "dx-theme" links with Knockout, call ko.applyBindings() within the **DevExpress.ui.themes.**[ready()](/Documentation/ApiReference/Common/utils/ui/themes/Methods/#readycallback) callback. Otherwise, widgets can be rendered incorrectly.
