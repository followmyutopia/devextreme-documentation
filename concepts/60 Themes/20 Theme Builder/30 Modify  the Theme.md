...
![Modify a Theme](Content/images/doc/17_2/PhoneJS/ModifyTheme.png)
...
- **Base Theming**  
    ...
    ![Modify Widget Styles](Content/images/doc/17_2/PhoneJS/BaseTheming.png)
    ...
    ![Upload Less Variables](Content/images/doc/17_2/PhoneJS/BaseThemingUploadLessVariables.png)
...
- **Advanced Theming**  
    ...
    ![Modify Widget Styles](Content/images/doc/17_2/PhoneJS/AdvancedTheming.png)

You can undo/redo the last change you made to the theme.

![Undo and Redo Changes](Content/images/doc/17_2/PhoneJS/UndoRedo.png)

To undo all changes made during the current session on the site, press the **Reset** button.

![Reset Changes](Content/images/doc/17_2/PhoneJS/ResetChanges.png)
