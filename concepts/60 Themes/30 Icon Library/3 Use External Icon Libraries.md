...
To display an icon from an external library within a UI widget, pass a css selector of the required icon to the **icon** option of the [widget](/Documentation/Guide/Themes/Icon_Library/#Use_Icons_for_Widgets) or [command](/Documentation/Guide/Themes/Icon_Library/#Use_Icons_for_Commands), or to the **icon** field of an item object if you need to display an icon for a collection widget item.
