    ...
    <script type="text/template"> 
        {
            ...
            "images": [
                { "image": "/Content/images/doc/18_1/UiWidgets/Box/Box_direction_row.png", "text": "<b>direction</b>: <i>'row'</i>" },
                { "image": "/Content/images/doc/18_1/UiWidgets/Box/Box_direction_column.png", "text": "<b>direction</b>: <i>'col'</i>" }
            ]
        }
    </script>
</div>
