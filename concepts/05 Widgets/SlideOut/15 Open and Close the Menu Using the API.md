To open or close the **SlideOut** menu programmatically, call the [showMenu()](/Documentation/ApiReference/UI_Widgets/dxSlideOut/Methods/#showMenu) or [hideMenu()](/Documentation/ApiReference/UI_Widgets/dxSlideOut/Methods/#hideMenu) method. You can do the same thing using the [toggleMenuVisibility(showing)](/Documentation/ApiReference/UI_Widgets/dxSlideOut/Methods/#toggleMenuVisibilityshowing) method. Pass **true** or **false** to this method to open or close the menu, respectively. For example, the following code shows how to close the slide-out menu when a user selects a command on it.
