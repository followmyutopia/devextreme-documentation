...
You can implement a custom handler for a key using the [registerKeyHandler(key, handler)](/Documentation/ApiReference/UI_Widgets/dxLookup/Methods/#registerKeyHandlerkey_handler) method.
