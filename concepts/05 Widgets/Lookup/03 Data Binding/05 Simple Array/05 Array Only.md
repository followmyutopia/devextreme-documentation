Bind the **Lookup** to an array by passing it to the [dataSource](/Documentation/ApiReference/UI_Widgets/dxLookup/Configuration/#dataSource) option. The array may contain primitive values...
