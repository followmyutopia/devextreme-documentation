If you do not explicitly specify certain columns' [width](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/columns/#width), the **DataGrid** distributes the available space equally among columns at startup. As a result, cell values may appear truncated. Use the [columnMinWidth](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/#columnMinWidth) option to specify a minimum width for all columns and the [minWidth](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/columns/#minWidth) for an individual column. Note that all these settings may cause horizontal scrolling if columns cannot fit into the widget's width.
