...
- Client-side exporting in **IE9** and **Safari on MacOS** is possible only through a [proxy on the server](/Documentation/Guide/Widgets/DataGrid/Client-Side_Exporting/#Set_Up_a_Server-Side_Proxy).
