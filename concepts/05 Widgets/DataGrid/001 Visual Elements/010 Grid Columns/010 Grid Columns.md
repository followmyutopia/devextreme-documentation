There are two central elements, which the **DataGrid** widget is built on: grid columns and [grid rows](/Documentation/Guide/Widgets/DataGrid/Visual_Elements/#Grid_Rows). This topic covers the main features of grid columns and the ways they can be configured.
