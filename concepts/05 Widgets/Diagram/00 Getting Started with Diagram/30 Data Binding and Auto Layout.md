...
Use the [layout](/Documentation/ApiReference/UI_Widgets/dxDiagram/Configuration/#layout) option to specify an auto-layout algorithm (*"sugiyama"* or *"tree"*) that widget uses to build a diagram.