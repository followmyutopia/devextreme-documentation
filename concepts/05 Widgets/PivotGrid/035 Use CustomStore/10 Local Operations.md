By default, the widget performs all the operations locally. In the [load](/Documentation/ApiReference/Data_Layer/CustomStore/Configuration/#load) function of the pivot grid data source, you can just define from what web service return data.
