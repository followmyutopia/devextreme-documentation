If you develop using the [Node.js](http://nodejs.org/) platform, utilize a special script allowing you to parse binary sources and generate **VectorMap**-compatible files from them. This script can be found in the **Lib/js/vectormap-utils** folder of your DevExtreme package. Load this script as a [module](http://nodejs.org/api/modules.html) using the following code.
