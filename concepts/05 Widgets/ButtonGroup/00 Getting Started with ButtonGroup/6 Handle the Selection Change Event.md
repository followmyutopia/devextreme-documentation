Assign a function to the [onSelectionChanged](/Documentation/ApiReference/UI_Widgets/dxButtonGroup/Configuration/#onSelectionChanged) option. In this tutorial, the function logs the added or removed style's name to the browser's console: 
