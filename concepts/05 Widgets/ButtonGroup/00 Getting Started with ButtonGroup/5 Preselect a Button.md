Populate the [selectedItemKeys](/Documentation/ApiReference/UI_Widgets/dxButtonGroup/Configuration/#selectedItemKeys) array with the keys of the buttons that should be preselected. In this tutorial, we add the *"italic"* button to this array.
