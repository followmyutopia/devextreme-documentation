...
Note that **rendered** (for example **onItemRendered**, **onGroupRendered**) event handlers for collection items have other parameters. For more information, refer to the [Customize Collection Item Appearance](/Documentation/Guide/Widgets/Common/UI_Widgets/Customize_Widget_Element_Appearance/#Customize_Collection_Item_Appearance) article.
