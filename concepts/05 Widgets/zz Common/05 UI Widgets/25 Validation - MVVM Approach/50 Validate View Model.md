...
![Validated View Model](/Content/images/doc/17_2/Common/ValidatedViewModel.png)
...
Generally, the structure of the **dxValidator** object repeats the structure of the [Validator](/Documentation/ApiReference/UI_Widgets/dxValidator/) widget's configuration object.
