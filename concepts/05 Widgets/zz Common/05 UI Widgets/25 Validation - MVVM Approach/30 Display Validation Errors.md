...
![Validated Editors](/Content/images/doc/17_2/Common/ValidatedEditors.png)
...
![Validation Summary](/Content/images/doc/17_2/Common/ValidationSummary.png)

<article data-show="Content/Applications/17_2/UIWidgets/Validation/DisplayValidationErrors/markup.html,
        Content/Applications/17_2/UIWidgets/Validation/DisplayValidationErrors/script.js">

To associate the **ValidationSummary** widget with a validation group, add the **ValidationSummary** widget inside of the element representing the [ValidationGroup](/Documentation/ApiReference/UI_Widgets/dxValidationGroup/) widget.
