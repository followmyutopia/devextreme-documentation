...
A LocalStore has many more options available for configuring. For a full list, refer to the [LocalStore](/api-reference/30%20Data%20Layer/LocalStore/LocalStore.md '/Documentation/ApiReference/Data_Layer/LocalStore/') reference section.
