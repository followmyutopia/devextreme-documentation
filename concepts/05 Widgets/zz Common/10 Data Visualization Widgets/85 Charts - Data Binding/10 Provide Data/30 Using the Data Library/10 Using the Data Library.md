...
* [ArrayStore](/Documentation/Guide/Widgets/Common/Data_Visualization_Widgets/Charts_-_Data_Binding/Provide_Data/#Using_the_Data_Library/Using_an_ArrayStore) - provides access to an in-memory array
* [LocalStore](/Documentation/Guide/Widgets/Common/Data_Visualization_Widgets/Charts_-_Data_Binding/Provide_Data/#Using_the_Data_Library/Using_a_LocalStore) - provides access to the HTML5 web storage
* [ODataStore](/Documentation/Guide/Widgets/Common/Data_Visualization_Widgets/Charts_-_Data_Binding/Provide_Data/#Using_the_Data_Library/Using_an_ODataStore) - provides access to a remote OData service
* [CustomStore](/Documentation/Guide/Widgets/Common/Data_Visualization_Widgets/Charts_-_Data_Binding/Provide_Data/#Using_the_Data_Library/Using_a_CustomStore) - allows you to implement your own data access logic

**Chart**, **PieChart** and **Sparkline** accept a DataSource instance that must have its **store** field specified. You must assign an object configuring the required store to this field. This rule, however, can be ignored if you use a [CustomStore](/Documentation/Guide/Widgets/Common/Data_Visualization_Widgets/Charts_-_Data_Binding/Provide_Data/#Using_the_Data_Library/Using_a_CustomStore). In this case, specify all store settings directly in the instance object, omitting the use of the **store** field.
