...
The **Tooltip** can also be hidden when a user clicks outside it. To control this behavior of the **Tooltip**, use the [closeOnOutsideClick](/Documentation/ApiReference/UI_Widgets/dxTooltip/Configuration/#closeOnOutsideClick) option.
