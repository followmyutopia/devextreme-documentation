...
You can implement a custom handler for a key using the [registerKeyHandler(key, handler)](/Documentation/ApiReference/UI_Widgets/dxTreeView/Methods/#registerKeyHandlerkey_handler) method.
