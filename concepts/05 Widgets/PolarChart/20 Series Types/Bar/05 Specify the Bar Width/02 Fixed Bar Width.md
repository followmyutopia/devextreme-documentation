The [barWidth](/Documentation/ApiReference/Data_Visualization_Widgets/dxPolarChart/Configuration/series/#barWidth) option specifies fixed angular bar width in degrees. This option is available for each series.
