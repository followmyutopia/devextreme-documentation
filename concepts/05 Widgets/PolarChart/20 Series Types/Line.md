...
![PolarLineSeriesType ChartJS](/Content/images/doc/16_2/ChartJS/PolarLine.png)
...
![Transformation from Rectangular to Polar Coordinates PolarLineSeriesType ChartJS](/Content/images/doc/16_2/ChartJS/PolarLine_TransformationFromStandardChart.png)
...
![Smooth PolarLineSeriesType ChartJS](/Content/images/doc/16_2/ChartJS/PolarLine_Smooth.png)

When either argument or value axis is discrete, the line chart joins data points by straight lines.

![Discrete PolarLineSeriesType ChartJS](/Content/images/doc/16_2/ChartJS/PolarLine_Discrete.png)
...
![SpiderWeb PolarLineSeriesType ChartJS](/Content/images/doc/16_2/ChartJS/PolarLine_useSpiderWeb.png)
...
![Cyclic PolarLineSeriesType ChartJS](/Content/images/doc/16_2/ChartJS/PolarLine_Smooth_Cyclic.png)
...
![Closed Cyclic PolarLineSeriesType ChartJS](/Content/images/doc/16_2/ChartJS/PolarLine_Smooth_Cyclic_Closed.png)
...
*   **Line Point Options**  
    Set up the series' [point](/Documentation/ApiReference/Data_Visualization_Widgets/dxPolarChart/Configuration/commonSeriesSettings/point/) object (see the [Series Points](/Documentation/Guide/Widgets/Chart/Visual_Elements/#SeriesPoints) topic).
