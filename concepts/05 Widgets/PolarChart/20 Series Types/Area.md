...
![AreaPolarSeriesType ChartJS](/Content/images/doc/19_2/ChartJS/PolarArea.png)
...
![Transformation from Rectangular to Polar Coordinates PolarAreaSeriesType ChartJS](/Content/images/doc/19_2/ChartJS/PolarArea_TransformationFromStandardChart.png)
...
![Smooth PolarAreaSeriesType ChartJS](/Content/images/doc/19_2/ChartJS/PolarArea_Smooth.png)

When either the argument or value axis is discrete, the area chart joins data points by straight lines.

![Discrete PolarAreaSeriesType ChartJS](/Content/images/doc/19_2/ChartJS/PolarArea_Discrete.png)
...
![SpiderWeb PolarAreaSeriesType ChartJS](/Content/images/doc/19_2/ChartJS/PolarArea_useSpiderWeb.png)
...
*   **Point Label Options**  
    Make point labels visible by setting the **visible** property of the series' [label](/api-reference/20%20Data%20Visualization%20Widgets/dxPolarChart/5%20Series%20Types/CommonPolarChartSeries/label/label.md '/Documentation/ApiReference/Data_Visualization_Widgets/dxPolarChart/Series_Types/AreaSeries/label/') object. For details on other label options, refer to the [Series Point Labels](/concepts/05%20Widgets/PolarChart/10%20Visual%20Elements/030%20Series%20Point%20Labels.md '/Documentation/Guide/Widgets/PolarChart/Visual_Elements/#Series_Point_Labels') topic.

These and other options that can be set for series of the *area* type are explained in the [AreaSeries](/api-reference/20%20Data%20Visualization%20Widgets/dxPolarChart/5%20Series%20Types/AreaSeries/AreaSeries.md '/Documentation/ApiReference/Data_Visualization_Widgets/dxPolarChart/Series_Types/AreaSeries/') Reference section. Set the required series options within the [series](/api-reference/20%20Data%20Visualization%20Widgets/dxPolarChart/1%20Configuration/series/series.md '/Documentation/ApiReference/Data_Visualization_Widgets/dxPolarChart/Configuration/series/') object of the chart's configuration object.