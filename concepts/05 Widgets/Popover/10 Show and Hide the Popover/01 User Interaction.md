...
The **Popover** can also be hidden when a user clicks outside it. To control this behavior of the **Popover**, use the [closeOnOutsideClick](/Documentation/ApiReference/UI_Widgets/dxPopover/Configuration/#closeOnOutsideClick) option.
