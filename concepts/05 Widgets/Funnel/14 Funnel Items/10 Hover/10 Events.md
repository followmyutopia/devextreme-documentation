When a funnel item's hover state is being changed, the **Funnel** raises the [hoverChanged](/api-reference/20%20Data%20Visualization%20Widgets/dxFunnel/4%20Events/hoverChanged.md '/Documentation/ApiReference/Data_Visualization_Widgets/dxFunnel/Events/#hoverChanged') event that you can handle with a function. If the handling function is not going to be changed during the lifetime of the widget, assign it to the [onHoverChanged](/api-reference/20%20Data%20Visualization%20Widgets/dxFunnel/1%20Configuration/onHoverChanged.md '/Documentation/ApiReference/Data_Visualization_Widgets/dxFunnel/Configuration/#onHoverChanged') option when you configure the widget. To check whether the pointer entered or left a funnel item, call the item's [isHovered()](/Documentation/ApiReference/Data_Visualization_Widgets/dxFunnel/Item/Methods/#isHovered) method.
