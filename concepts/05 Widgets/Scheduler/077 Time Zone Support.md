Appointments are displayed in the client time zone. The time-zone offset specified in the [startDate](/Documentation/ApiReference/UI_Widgets/dxScheduler/Default_Appointment_Template/#startDate) or [endDate](/Documentation/ApiReference/UI_Widgets/dxScheduler/Default_Appointment_Template/#endDate) is also taken into account (if there is any). You can force a time zone for an individual appointment via its [startDateTimeZone](/Documentation/ApiReference/UI_Widgets/dxScheduler/Default_Appointment_Template/#startDateTimeZone) and [endDateTimeZone](/Documentation/ApiReference/UI_Widgets/dxScheduler/Default_Appointment_Template/#endDateTimeZone) fields or for all appointments in the widget via its [timeZone](/Documentation/ApiReference/UI_Widgets/dxScheduler/Configuration/#timeZone) option. **timeZone** takes precedence over **start**/**endDateTimeZone**.
