...
![Month View](/Content/images/doc/17_1/UiWidgets/Scheduler_Month_View.png)

By default, a day cell holds one or two appointments; all others are shown collapsed. 

![Collapsed appointments](/Content/images/doc/17_1/UiWidgets/Scheduler_Month_Collapsed_Appointments.png)
...
![Appointment collector](/Content/images/doc/17_1/UiWidgets/Scheduler_Month_Appointment_Collector.png)

To view associated appointments, a user should click the appointment collector. 

![Drop-down List of Appointments](/Content/images/doc/17_1/UiWidgets/Scheduler_Month_DropDown_List.png)

If you [group appointments by resources](/Documentation/Guide/Widgets/Scheduler/Resources/Group_Appointments_by_Resources/), the resource headers are located above the day scale.

![Resource Headers](/Content/images/doc/17_1/UiWidgets/Scheduler_Month_Resource_Headers.png)
