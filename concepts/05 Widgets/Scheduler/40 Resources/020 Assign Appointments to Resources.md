Each appointment in the **Scheduler** widget can be associated with one or several resources of one or several resource kinds. To associate an appointment with a resource, the object defining the corresponding resource kind must have the [field](/Documentation/ApiReference/UI_Widgets/dxScheduler/Configuration/resources/#field) field. In this instance, you can refer an appointment to a resource of this resource kind by adding a data source field with the name specified by the resource kind object's **field** field.
...
![Scheduler Appointment Resources](/Content/images/doc/16_2/UiWidgets/Scheduler_ColorResourceIndication.png)
...
![Scheduler Appointment Resources](/Content/images/doc/16_2/UiWidgets/Scheduler_Resources_Details.png)
...
![Scheduler Appointment Resources](/Content/images/doc/16_2/UiWidgets/Scheduler_Resources_SelectBox.png)