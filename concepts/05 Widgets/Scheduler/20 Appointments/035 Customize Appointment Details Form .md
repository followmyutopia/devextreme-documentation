...
- Create the [onAppointmentFormCreated](/Documentation/ApiReference/UI_Widgets/dxScheduler/Configuration/#onAppointmentFormCreated) handler to obtain the [Form](/Documentation/ApiReference/UI_Widgets/dxForm/) instance, used to render the appointment details.
...
- Use the [itemOption](/Documentation/ApiReference/UI_Widgets/dxForm/Methods/#itemOptionfield_options) method to update form item options.
