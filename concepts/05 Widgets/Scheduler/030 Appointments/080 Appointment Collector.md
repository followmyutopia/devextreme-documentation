...
![Scheduler Appointment Collector and Drop-Down List](/Content/images/doc/18_2/UiWidgets/Scheduler_Appointment_Collector_and_Drop-Down_List.png)
...
In case of jQuery, you can also use a 3rd-party template engine to customize the widget's appearance. See the [3rd-Party Template Engines](/Documentation/Guide/Widgets/Common/Templates/#3rd-Party_Template_Engines) article for more information.
