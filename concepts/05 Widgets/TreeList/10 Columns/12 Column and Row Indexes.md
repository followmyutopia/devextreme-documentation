...
- **Initial Column Index** (or simply **Column Index**)        
    Equals the column's index in the [columns](/api-reference/10%20UI%20Widgets/dxTreeList/1%20Configuration/columns/columns.md '/Documentation/ApiReference/UI_Widgets/dxTreeList/Configuration/columns/') array. 

- **Visible Column Index**      
    Depends on the column's current location in the **TreeList** and changes dynamically when columns are [reordered](/concepts/05%20Widgets/TreeList/10%20Columns/25%20Column%20Reordering/Column%20Reordering.md '/Documentation/Guide/Widgets/TreeList/Columns/Column_Reordering/').

    ![DevExtreme HTML5 JavaScript TreeList Visible Column Index](/Content/images/doc/19_2/TreeList/visual_elements/columnIndexes.png)
