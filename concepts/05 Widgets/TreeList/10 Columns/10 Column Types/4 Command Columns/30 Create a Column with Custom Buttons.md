The following code shows how to add a command column with custom [buttons](/api-reference/_hidden/dxTreeListColumn/buttons/buttons.md '/Documentation/ApiReference/UI_Widgets/dxTreeList/Configuration/columns/buttons/'). Note that the editing column should be declared explicitly because a custom command column replaces it.
