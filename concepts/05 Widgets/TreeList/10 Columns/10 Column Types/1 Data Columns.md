Data columns are the most common type of columns used in the **TreeList** widget. They are generated for all members of the [columns](/api-reference/10%20UI%20Widgets/dxTreeList/1%20Configuration/columns/columns.md '/Documentation/ApiReference/UI_Widgets/dxTreeList/Configuration/columns/') array that do not configure [band columns](/concepts/05%20Widgets/TreeList/10%20Columns/10%20Column%20Types/2%20Band%20Columns.md '/Documentation/Guide/Widgets/TreeList/Columns/Column_Types/#Band_Columns'). Usually, a data column displays values from a [data field](/api-reference/_hidden/GridBaseColumn/dataField.md '/Documentation/ApiReference/UI_Widgets/dxTreeList/Configuration/columns/#dataField') to which it is bound, but you can populate a data column with custom values (see [Customize Cells](/concepts/05%20Widgets/TreeList/10%20Columns/40%20Customize%20Cells/Customize%20Cells.md '/Documentation/Guide/Widgets/TreeList/Columns/Customize_Cells/')).

![DevExtreme HTML5 JavaScript TreeList DataColumns](/Content/images/doc/19_2/treelist/visual_elements/column-types_data.png)
