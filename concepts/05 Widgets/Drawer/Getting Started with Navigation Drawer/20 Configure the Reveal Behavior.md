When you open the **Drawer**, it can slide in or expand from the closed position. Use the [revealMode](/Documentation/ApiReference/UI_Widgets/dxDrawer/Configuration/#revealMode) option to specify this behavior.
