In addition to the major grid built on major ticks, the **Chart** provides a minor grid built on [minor ticks](/Documentation/Guide/Widgets/Chart/Axes/Axis_Ticks/).

![DevExtreme HTML5 JavaScript Charts MinorGridLines](/Content/images/doc/17_2/ChartJS/visual_elements/minor_grid_lines.png)
...
- **commonAxisSettings** | [minorGrid](/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Configuration/commonAxisSettings/minorGrid/)         
