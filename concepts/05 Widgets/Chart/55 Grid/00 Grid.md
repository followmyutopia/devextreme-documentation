A grid is a set of mutually-crossing vertical and horizontal lines that stretch throughout the entire chart. Visually, grid lines can be considered extensions of [major ticks](/Documentation/Guide/Widgets/Chart/Visual_Elements/#Axis_Ticks). The grid improves the readability of chart data.

![DevExtreme HTML5 JavaScript Charts GridLines](/Content/images/doc/16_2/ChartJS/visual_elements/grid_lines.png)
