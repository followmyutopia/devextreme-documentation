The **Chart** provides the [customizePoint](/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Configuration/#customizePoint) and [customizeLabel](/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Configuration/#customizeLabel) functions specifically for changing individual point and label options. Any other widget options can be changed in the **Chart**'s **onPointClick** event handler, but remember to change them back in the **Button**'s **onClick** event handler.
