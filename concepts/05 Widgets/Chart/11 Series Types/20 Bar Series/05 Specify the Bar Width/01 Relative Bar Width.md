Regulating the empty space on a bar's sides controls the relative bar width. Use the [barPadding](/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Configuration/series/#barPadding) option to specify how much of the available sector should be empty. For example, a **barPadding** of 0.1 leaves 10% of the available space empty giving the rest to the bar.
    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td><img src="/Content/images/doc/19_1/ChartJS/barwidth/1.png" /></td>
            </tr>
            <tr>
                <td>barGroupPadding: 0.2 <br/> barPadding: 0</td>
                <td><img src="/Content/images/doc/19_1/ChartJS/barwidth/2.png" /></td>
            </tr>
            <tr>
                <td>barGroupPadding: 0.2 <br/> barPadding: 0.1</td>
                <td><img src="/Content/images/doc/19_1/ChartJS/barwidth/3.png" /></td>
            </tr>
        </tbody>
    </table>
</div>