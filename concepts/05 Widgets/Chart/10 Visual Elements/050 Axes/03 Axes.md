...
![Axes](/Content/images/doc/16_2/ChartJS/Axes.png)

Depending on the specified data, the axes can be discrete, continuous or logarithmic. For details, refer to the [Argument Axis](/Documentation/Guide/Widgets/Chart/Visual_Elements/#Axes/Argument_Axis) and [Value Axis](/Documentation/Guide/Widgets/Chart/Visual_Elements/#Axes/Value_Axis) topics.
