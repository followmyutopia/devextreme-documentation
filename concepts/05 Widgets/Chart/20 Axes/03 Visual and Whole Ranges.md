...
<div id="figures">
    <figure>
        <img src="/Content/images/doc/20_1/ChartJS/visual-range-unspecified.png" alt="Visual range is unspecified" />
        <figcaption>Visual range is unspecified</figcaption>
    </figure>

    <figure>
        <img src="/Content/images/doc/20_1/ChartJS/visual-range-specified.png" alt='Visual range is ["A", "F"]' />
