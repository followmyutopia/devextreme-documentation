...
<div id="figures">
    <figure>
        <img src="/Content/images/doc/18_2/ChartJS/visual-range-unspecified.png" alt="Visual range is unspecified" />
        <figcaption>Visual range is unspecified</figcaption>
    </figure>

    <figure>
        <img src="/Content/images/doc/18_2/ChartJS/visual-range-specified.png" alt='Visual range is ["A", "F"]' />
