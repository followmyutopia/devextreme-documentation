...
Start configuring the **Sankey** by binding it to your data source. Refer to the articles in the [Data Binding](/Documentation/Guide/Widgets/Sankey/Data_Binding/) section for more information.
...
<img src="/Content/images/doc/18_2/Sankey/overview.png" style="display:block;margin-left:auto;margin-right:auto" usemap="#image-map" alt="DevExtreme HTML5 JavaScript Sankey">
