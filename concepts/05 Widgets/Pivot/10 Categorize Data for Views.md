...
The `contacts` array will be used as a data source for all views, but depending on the view, different [filters](/Documentation/ApiReference/Data_Layer/DataSource/Configuration/#filter) will be applied to it.
...
Note that the **Pivot** in this example employs DevExtreme's own **DataSource** object to filter data. To learn more about this and other data-processing capabilities of this object, see the [Data Layer](/Documentation/Guide/Data_Layer/Data_Layer/) article.
