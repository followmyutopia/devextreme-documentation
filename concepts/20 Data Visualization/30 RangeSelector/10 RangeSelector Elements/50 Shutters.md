...
![ChartJS RangeSelector](/Content/images/doc/16_1/ChartJS/RangeSelectorShutters.png)
...
[note] Shutters are available only when the [background](/Documentation/Guide/Data_Visualization/RangeSelector/RangeSelector_Elements/#Background) is set.
