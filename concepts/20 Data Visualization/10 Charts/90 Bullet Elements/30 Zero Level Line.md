A zero level line indicates zero on a bullet graph. It serves as a starting point to the [bullet bar](/Documentation/Guide/Data_Visualization/Charts/Bullet_Elements/#Bullet_Bar).

![DevExtreme ChartJS BulletChart BulletGraph](/Content/images/doc/16_1/ChartJS/BulletZeroLine.png)
...
When visible, the zero level line has the same color as the [target line](/Documentation/Guide/Data_Visualization/Charts/Bullet_Elements/#Target_Line). This color is specified by the [targetColor](/Documentation/ApiReference/Data_Visualization_Widgets/dxBullet/Configuration/#targetColor) option.
