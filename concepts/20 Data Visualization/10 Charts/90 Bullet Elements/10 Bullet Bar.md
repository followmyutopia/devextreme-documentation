...
![DevExtreme ChartJS BulletChart BulletGraph](/Content/images/doc/16_1/ChartJS/BulletBar.png)
...
To distinguish positive and negative values visually, the **Bullet** widget features a [zero level line](/Documentation/Guide/Data_Visualization/Charts/Bullet_Elements/#Zero_Level_Line). Positive values are drawn to the right from this line; negative ones - to the left.
