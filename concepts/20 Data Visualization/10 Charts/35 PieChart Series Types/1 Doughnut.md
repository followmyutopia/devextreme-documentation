...
![DoughnutSeriesType DonutSeriesType ChartJS](/Content/images/doc/16_1/ChartJS/Doughnut.png)
...
*   **Slice Color**  
    Colors from the **PieChart**'s [palette](/Documentation/ApiReference/Data_Visualization_Widgets/dxPieChart/Configuration/) are used by default. To set custom colors for the doughnut slices, introduce a new palette and use it in your **PieChart**. To learn how to do this, refer to the [Palettes](/Documentation/Guide/Data_Visualization/Common/Appearance_Customization/#Palettes) topic.
