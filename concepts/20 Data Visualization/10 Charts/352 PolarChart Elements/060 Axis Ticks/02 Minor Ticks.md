In addition to the [axis ticks](/Documentation/Guide/Data_Visualization/Charts/PolarChart_Elements/#Axis_Ticks), the **PolarChart** widget provides the capability to draw minor ticks.  Minor ticks divide an axis segment that lies between two neighboring axis ticks. 

![Minor Ticks](/Content/images/doc/16_1/ChartJS/Polar_Minor_Ticks.png)
