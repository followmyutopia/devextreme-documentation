Chart [axes](/Documentation/Guide/Data_Visualization/Charts/Chart_Elements/#Axes) can be displayed with titles, which you can utilize to provide explanatory text for axis value units.

![Axis Titles](/Content/images/doc/16_1/ChartJS/AxesTitles.png)
