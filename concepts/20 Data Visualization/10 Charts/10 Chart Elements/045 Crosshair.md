...
* **Labels**		
Crosshair labels indicate the argument and the value of the [series point](/Documentation/Guide/Data_Visualization/Charts/Chart_Elements/#Series_Points) that the crosshair pointer currently focuses on. Use the [label](/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Configuration/crosshair/label/) object to configure the crosshair labels.
