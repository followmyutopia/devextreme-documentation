...
In **Chart**, the majority of [series types](/Documentation/Guide/Data_Visualization/Charts/Chart_Series_Types/) requires one value for one argument to define one series point. Data sources for such series are represented above. However, there are series types that require two or more values for one argument to define one point. For example, a [range area](/Documentation/Guide/Data_Visualization/Charts/Chart_Series_Types/#Range_Area) or [range bar](/Documentation/Guide/Data_Visualization/Charts/Chart_Series_Types/#Range_Bar) series needs two values, while a [candle stick](/Documentation/Guide/Data_Visualization/Charts/Chart_Series_Types/#Candle_Stick) or [stock](/Documentation/Guide/Data_Visualization/Charts/Chart_Series_Types/#Stock) series needs four values for one argument. The code snippet below shows how to implement a data source for two series of the range bar type.
...
After you have implemented a data source, bind it to your widget. To learn how to do this, refer to the [Bind Data](/Documentation/Guide/Data_Visualization/Charts/Data_Binding/#Bind_Data) topic.
