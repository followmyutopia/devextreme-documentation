To select a data point, use its **select()** method. For instance, you can select a point on a click using the chart's **onPointClick** handler (see [Click Handling](/Documentation/Guide/Data_Visualization/Charts/End-User_Interaction/#Click_Handling)).
