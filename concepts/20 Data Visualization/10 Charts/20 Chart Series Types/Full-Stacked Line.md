...
![FullStackedLineSeriesType ChartJS](/Content/images/doc/16_1/ChartJS/FullStackedLine.png)
...
*   **Line Width**  
    Change the line width using the series' **width** property. To set the line width when the line is hovered or selected, set the **width** property of the [hoverStyle](/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Series_Types/FullStackedLineSeries/hoverStyle/) or [selectionStyle](/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Series_Types/FullStackedLineSeries/)object defined within the **series** configuration object.
