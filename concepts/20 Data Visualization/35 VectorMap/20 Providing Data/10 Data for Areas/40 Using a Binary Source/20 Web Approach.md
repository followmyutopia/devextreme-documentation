...
Reference an additional script in the head of your HTML document as follows. This script can be found in the **Lib/js/vectormap-utils** folder of your [DevExtreme package](/Documentation/Guide/Common/DevExtreme_Packages/).
