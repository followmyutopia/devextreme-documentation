A tooltip is a small popup rectangle containing information about an [area](/Documentation/Guide/Data_Visualization/VectorMap/Map_Elements/#Areas) or a [marker](/Documentation/Guide/Data_Visualization/VectorMap/Map_Elements/#Markers) when a user hovers the mouse pointer over it. In common cases, a tooltip is required to display the name of the area or marker. However, it can display any information you may find useful.

![DevExtreme ChartJS VectorMap](/Content/images/doc/16_1/ChartJS/MapTooltip.png)
