...
You can define multiple views/layouts with the same name that are targeted for different devices. To set a target device for a view/layout, use the fields of the [device](/Documentation/ApiReference/Common/Object_Structures/device/) object as markup options of the **dxView**/**dxLayout** components.
...
See a step-by-step example in the <a href="/Documentation/17_1/Tutorial/SPA_Framework/Define_Device-Specific_View_Markup#Define_Device-Specific_View_Markup">Define Device-Specific View Markup</a> tutorial.
