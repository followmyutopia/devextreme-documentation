The replacement of a view with another view is initiated by invoking the [navigate](/Documentation/ApiReference/SPA_Framework/HtmlApplication/Methods/#navigateuri_options) method of the **HtmlApplication** object. When the application navigates to a view, the previous view is hidden or disposed. When it is hidden, this view can be restored from the cache quickly to be displayed again. When it is disposed, a new life cycle is initiated when the application navigates to this view repeatedly. All of the view life cycle steps are detailed below.
...
![Step 1](/Content/images/doc/16_1/PhoneJS/ViewLifeCycle_Step1.png)  
...
- [navigating](/Documentation/ApiReference/SPA_Framework/HtmlApplication/Events/#navigating)  
...
- [resolveLayoutController](/Documentation/ApiReference/SPA_Framework/HtmlApplication/Events/#resolveLayoutController)  
	This event fires before an appropriate layout controller from the application's [layout set](/Documentation/Guide/SPA_Framework/Built-in_Layouts/#Ready-to-Use_Layout_Sets) is found, based on the current navigation context. Handle this event to set a custom layout controller for the displayed view. This layout controller will use the required layout template for the view.

<a id="CreateViewModel"></a><h4>2 - Create a View Model</h4>

![Step 2](/Content/images/doc/16_1/PhoneJS/ViewLifeCycle_Step3.png)  
...
- [beforeViewSetup](/Documentation/ApiReference/SPA_Framework/HtmlApplication/Events/#beforeViewSetup)  
...
- [afterViewSetup](/Documentation/ApiReference/SPA_Framework/HtmlApplication/Events/#afterViewSetup)  
...
![Step 3](/Content/images/doc/16_1/PhoneJS/ViewLifeCycle_Step4.png)  
...
![View Rendering](/Content/images/doc/16_1/PhoneJS/ViewRendering.png)
...
[note]The rendering process may take a lot of time in some views. In this instance, you can defer the rendering of some view elements and provide a quick request to an end-user. For this purpose, use the [DeferRendering](/Documentation/ApiReference/UI_Widgets/dxDeferRendering/) widget within the view. The content enclosed into this widget will be rendered and shown with specified animation at a specified moment. While waiting for this moment, the view will be shown with a loading indicator or a custom loading state indication. For details on how to use the **DeferRendering** widget for views, refer to the [Defer View Content Rendering](/Documentation/Guide/SPA_Framework/Views_and_Layouts/#Defer_View_Content_Rendering) topic.

<a id="ShowView"></a><h4>4 - Show the View</h4>

![Step 4](/Content/images/doc/16_1/PhoneJS/ViewLifeCycle_Step5.png)
...
![Show View](/Content/images/doc/16_1/PhoneJS/ShowView.png)
...
If the navigation to another view implies conserving the current view in the navigation history, the view markup becomes inactive. Information on the view is stored in the [cache](/Documentation/ApiReference/SPA_Framework/HtmlApplication/Configuration/#viewCache).
...
![Show View](/Content/images/doc/16_1/PhoneJS/ShowViewRepeatedly.png)
...
The following events are raised when the current view is not displayed and information on this view has already been removed from the [cache](/Documentation/ApiReference/SPA_Framework/HtmlApplication/Configuration/#viewCache). 
