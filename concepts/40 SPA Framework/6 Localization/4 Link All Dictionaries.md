...
- globalize libraries  
    Libraries containing the [globalize](https://github.com/jquery/globalize/) functionality, which can be found in the **Lib**/**js** folder within your [DevExtreme Package](/Documentation/Guide/Common/DevExtreme_Packages/). The list of libraries is presented below.
