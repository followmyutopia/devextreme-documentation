...
![Toolbar](Content/images/doc/16_2/DevExtreme/DesignerToolbar.png)
...
- **Select a project to show the view in its context**
	...
	When designing a view from a [Shared](/Documentation/Guide/VS_Integration/Project_Templates/#Multi-Channel_Application/Shared_Project) project, you can see how it looks in the final application.

To show/hide the **Device Settings Toolbar**, use the button that is displayed in the image below.

![Show Toolbar](Content/images/doc/16_2/DevExtreme/ShowToolbarButton.png)
