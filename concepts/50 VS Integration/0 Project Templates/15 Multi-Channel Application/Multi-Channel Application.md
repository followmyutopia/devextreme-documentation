**Multi-Channel Application** is a project template for building an HTML/JS application based on the [DevExtreme SPA Framework](/Documentation/Guide/Common/Introduction_to_DevExtreme/#Mobile_Development/Overview/SPA_Framework) and [DevExtreme widgets](/Documentation/Guide/Common/Introduction_to_DevExtreme/#Mobile_Development/Overview/UI_Widgets_Library). This project template is more helpful than the [Basic Application](/Documentation/17_1/Guide/VS_Integration/Project_Templates/#Basic_Application) project template in the following cases.
