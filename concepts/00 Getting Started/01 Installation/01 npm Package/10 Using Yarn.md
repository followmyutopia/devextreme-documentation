...
You should also install packages for [Angular](/Documentation/Guide/Angular_Components/Getting_Started/Add_DevExtreme_to_an_Angular_CLI_Application/), [Vue](https://github.com/DevExpress/devextreme-vue#install-devextreme), or [React](https://github.com/DevExpress/devextreme-react#install-devextreme) if you are going to use DevExtreme components with these frameworks.
