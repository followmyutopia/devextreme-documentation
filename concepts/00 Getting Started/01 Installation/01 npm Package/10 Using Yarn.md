...
You should also install packages for [Angular](https://github.com/DevExpress/devextreme-angular#add-to-existing-app), [Vue](https://github.com/DevExpress/devextreme-vue#install-devextreme), or [React](https://github.com/DevExpress/devextreme-react#install-devextreme) if you are going to use DevExtreme components with these frameworks.
