...
#####See Also#####
- **API Reference**.**WidgetName**.**Configuration**, for example, **API Reference**.[CheckBox](/Documentation/ApiReference/UI_Widgets/dxCheckBox/).[Configuration](/Documentation/ApiReference/UI_Widgets/dxCheckBox/Configuration/)
