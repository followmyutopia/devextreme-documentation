...
Add the [DevExtreme layout template](https://github.com/DevExpress/devextreme-angular-template#devextreme-angular-template) to an existing Angular application:
