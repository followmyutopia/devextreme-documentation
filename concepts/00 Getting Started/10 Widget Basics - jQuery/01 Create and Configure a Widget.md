...
DevExtreme supplies a jQuery plugin for each widget. To create, for example, the [Button](/Documentation/ApiReference/UI_Widgets/dxButton/) widget within the `buttonContainer` element, use the `dxButton()` plugin as the following code shows.
...
- [Get and Set Options - jQuery](/Documentation/17_1/Guide/Getting_Started/Widget_Basics_-_jQuery/Get_and_Set_Options)
