...
DevExtreme supplies a jQuery plugin for each widget. To create, for example, the [Button](/api-reference/10%20UI%20Widgets/dxButton/dxButton.md '/Documentation/ApiReference/UI_Widgets/dxButton/') widget within the `buttonContainer` element, use the `dxButton()` plugin as the following code shows.
...
#####See Also#####
- **API Reference**.**WidgetName**.**Configuration**, for example, **API Reference**.[Button](/api-reference/10%20UI%20Widgets/dxButton/dxButton.md '/Documentation/ApiReference/UI_Widgets/dxButton/').[Configuration](/api-reference/10%20UI%20Widgets/dxButton/1%20Configuration/Configuration.md '/Documentation/ApiReference/UI_Widgets/dxButton/Configuration/')
