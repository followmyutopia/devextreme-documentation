This guide gives a detailed overview of [Scheduler](/Documentation/ApiReference/UI_Widgets/dxScheduler/) visual elements. Each topic in this guide contains a brief description of an element and its main features, which can be configured.
