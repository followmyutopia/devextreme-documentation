...
[note] If you need to filter data by the [group field](/Documentation/Guide/UI_Widgets/Pivot_Grid/Grouping/#Fields_Grouping), assign an array of arrays to the [filterValues](/Documentation/ApiReference/Data_Layer/PivotGridDataSource/Configuration/fields/#filterValues) option. Each item of the **filterValues** array should contain a filtering condition for each field in the group.
