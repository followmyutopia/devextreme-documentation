To sort row or column fields by their own values, set the [sortOrder](/Documentation/ApiReference/Data_Layer/PivotGridDataSource/Configuration/fields/#sortOrder) option of the required field. For example, the following code sorts the *"Region"* field in descending order.
...
The code snippet above will sort the *"Region"* field by [Grand Totals](/Documentation/Guide/UI_Widgets/Pivot_Grid/Visual_Elements/#Totals). To sort the same field by Totals of a specific column, specify the path to this column using the [sortBySummaryPath](/Documentation/ApiReference/Data_Layer/PivotGridDataSource/Configuration/fields/#sortBySummaryPath) option. For example, the following code will sort the *"Region"* field by Totals of the *"2015"* column.
