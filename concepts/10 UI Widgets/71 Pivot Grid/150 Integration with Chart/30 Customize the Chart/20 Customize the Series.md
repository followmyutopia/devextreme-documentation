...
The **seriesOptions** can contain any appearance-related options from the [series](/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Configuration/series/) section of the reference.
...
[note]If you have set the [putDataFieldsInto](/Documentation/Guide/UI_Widgets/Pivot_Grid/Integration_with_Chart/#Convert_Grid_Fields_into_Chart_Series) field to *"args"*, **dataFieldsDisplayMode** will be set to *"singleAxis"* forcedly.