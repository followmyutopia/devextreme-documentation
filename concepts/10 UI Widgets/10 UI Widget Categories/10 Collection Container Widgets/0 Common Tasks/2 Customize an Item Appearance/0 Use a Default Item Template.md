...
In certain scenarios, it is enough to specify a simple array as a widget data source. In this instance, in Knockout approach, a default item template contains [text](http://knockoutjs.com/documentation/text-binding.html) binding associated with the current array value.