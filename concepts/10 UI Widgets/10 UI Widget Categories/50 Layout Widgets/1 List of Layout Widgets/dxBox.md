...
The [Box](/Documentation/ApiReference/UI_Widgets/dxBox/) widget provides an easy way to arrange the specified markup elements in a row or column.
...
The widget elements are usually specified using the **dxItem** markup component, as described in the [Specify Layout Elements](/Documentation/Guide/UI_Widgets/UI_Widget_Categories/Layout_Widgets/#Specify_Layout_Elements) section of this article. The **Box** items support the following options specifying element size.
...
For information on the complete set of item options, refer to the [Default Item Template](/Documentation/ApiReference/UI_Widgets/dxBox/Default_Item_Template/) reference section of this widget.
...
You can also specify the alignment applied to the the elements if they are not stretched to fill the entire widget container. For this purpose, the widget includes the [align](/Documentation/ApiReference/UI_Widgets/dxBox/Configuration/#align) and [crossAlign](/Documentation/ApiReference/UI_Widgets/dxBox/Configuration/#crossAlign) options, which specify alignment along the specified direction and cross-wise respectively.
</article>