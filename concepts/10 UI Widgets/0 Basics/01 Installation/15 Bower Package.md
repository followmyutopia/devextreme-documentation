...
If you use the [client-side export](/Documentation/Guide/UI_Widgets/Data_Grid/Client-Side_Export/), also install the JSZip library.
...
1. Open the *bower.json* file located in the root folder of your application project.
    ...
    ![Bower - .json file](/Content/images/doc/16_1/UiWidgets/BowerJSONFile.png) 
