You can find all the required files in your [DevExtreme package](/Documentation/Guide/Common/DevExtreme_Packages/). Place the **Lib** folder of this package into the folder with your application. Then, depending on the library or framework you use in your app, link the needed files within the `<head>` tag of your index page in the given order.
...
If you use the [client-side export](/Documentation/Guide/UI_Widgets/Data_Grid/Client-Side_Export/), add references to the JSZip library.
