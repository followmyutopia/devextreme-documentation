...
To create, for example, the [Menu](/Documentation/ApiReference/UI_Widgets/dxMenu/) widget, add a `<div>` element to the `<body>` tag of your page and use the `dxMenu` binding as the following code shows.
