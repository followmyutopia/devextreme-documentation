The main item type used in a form is [Simple](/Documentation/ApiReference/UI_Widgets/dxForm/Simple_Item/). An item of this type consists of a label and an editor. In addition, a help text can be displayed under the editor.
...
For the complete list of simple item configuration options, refer to the [Simple Item](/Documentation/ApiReference/UI_Widgets/dxForm/Simple_Item/) API reference.