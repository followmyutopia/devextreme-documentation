To add and remove markers, use the [addMarker(markerOptions)](/Documentation/ApiReference/UI_Widgets/dxMap/Methods/#addMarkermarkerOptions) and [removeMarker(marker)](/Documentation/ApiReference/UI_Widgets/dxMap/Methods/#removeMarkermarker) methods respectively.
...
You can pass the array of the required markers to the [markers](/Documentation/ApiReference/UI_Widgets/dxMap/Configuration/#markers) option to display them immediately after the widget is created.
