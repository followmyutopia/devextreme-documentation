If you need the **DataGrid** widget to work with local data, use the [ArrayStore](/Documentation/Guide/UI_Widgets/Data_Grid/Data_Binding/#Provide_Data/Using_the_Data_Layer/Using_an_ArrayStore) or [LocalStore](/Documentation/Guide/UI_Widgets/Data_Grid/Data_Binding/#Provide_Data/Using_the_Data_Layer/Using_a_LocalStore). 
...
[note] When the amount of data is large, it is also recommended that you [deny grouping by columns](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/columns/#allowGrouping) whose values are mostly unique. 