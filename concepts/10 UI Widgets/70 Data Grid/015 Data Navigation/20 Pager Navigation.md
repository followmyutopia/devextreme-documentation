...
#####See Also#####
- [DataGrid - Pager](/Documentation/Guide/UI_Widgets/Data_Grid/Visual_Elements/#Pager)

[note] In order to use the pager, data paging must be [enabled](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/paging/#enabled).