Along with [grid columns](/Documentation/Guide/UI_Widgets/Data_Grid/Visual_Elements/#Grid_Columns), grid rows are a fundamental element in the **DataGrid** widget. A grid row is a grid element representing a structured data item. In fact, a grid can be thought of as consisting of rows and columns.

![DevExtreme DataGrid GridRows](/Content/images/doc/16_1/DataGrid/GridRows.png)
