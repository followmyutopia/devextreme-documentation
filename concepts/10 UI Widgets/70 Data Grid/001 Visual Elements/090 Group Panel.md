To [group](/Documentation/Guide/UI_Widgets/Data_Grid/Grouping/) grid records, use a group panel. A user can drag-and-drop columns onto and from it, thus grouping grid records by these columns.

![DevExtreme DataGrid GroupPanel](/Content/images/doc/16_1/DataGrid/GroupPanel.png)
...
#####See Also#####
- For more information on grouping in **DataGrid**, refer to the [Grouping](/Documentation/Guide/UI_Widgets/Data_Grid/Grouping/#Grouping) topic.
- When grid records are grouped, group rows are formed. To learn how to configure them, see the [Group Rows](/Documentation/Guide/UI_Widgets/Data_Grid/Visual_Elements/#Group_Rows) topic.    