...
[note]On rare occasions, when *virtual* scrolling mode is used, selection made with *SHIFT+Click* may be reset. This is explained by the technical peculiarities of this mode. See the [Vertical Scrolling](/Documentation/Guide/UI_Widgets/Data_Grid/Data_Navigation/#Scrolling/Vertical_Scrolling) article for more details.

For an overview of all key combinations presented in **DataGrid**, refer to the [Keyboard Navigation](/Documentation/Guide/UI_Widgets/Data_Grid/Keyboard_Support/) article.
