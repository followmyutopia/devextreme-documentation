...
Additionally, a selected row can be deselected by a mouse click as you press the CTRL key. For information on keyboard shortcuts in **DataGrid**, see the [Keyboard Navigation](/Documentation/Guide/UI_Widgets/Data_Grid/Keyboard_Support/) and [Selecting Using Keyboard Shortcuts](/Documentation/Guide/UI_Widgets/Data_Grid/Selection/#Selecting_Using_Keyboard_Shortcuts) topics.

The animation below demonstrates how to perform selection in a single mode.

![DevExtreme DataGrid Selection](/Content/images/doc/16_1/DataGrid/SelectionSingle.gif)
