...
When row indexes are being calculated, data and group rows are counted, though only data rows can be selected. Refer to the [Grid Rows](/Documentation/Guide/UI_Widgets/Data_Grid/Visual_Elements/#Grid_Rows) article to get more information on how to calculate row indexes.
