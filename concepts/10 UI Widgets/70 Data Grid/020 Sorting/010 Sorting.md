Initially, grid records appear in an order specified in the data source. At runtime, these records can be sorted. To sort records by a column, a user must click its [header](/Documentation/Guide/UI_Widgets/Data_Grid/Visual_Elements/#Grid_Columns/Configuring_Column_Headers). The first click on the header applies an ascending sort order to the column. Each subsequent click reverses the sort order. When records are sorted by a column, its header is marked with an arrow.

![DevExtreme DataGrid Sorting](/Content/images/doc/16_1/DataGrid/SortedColumns.png)
...
![DevExtreme DataGrid SortingContextMenu](/Content/images/doc/16_1/DataGrid/SortingContextMenu.png)
