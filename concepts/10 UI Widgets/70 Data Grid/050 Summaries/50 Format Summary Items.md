...
A sample format configuration for the **variance** aggregate function created in the [Custom Aggregate Functions](/Documentation/Guide/UI_Widgets/Data_Grid/Summaries/#Custom_Aggregate_Functions) topic is shown below.
