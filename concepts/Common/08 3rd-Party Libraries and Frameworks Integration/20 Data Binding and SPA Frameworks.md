When using DevExtreme UI widgets, you may need [Knockout](http://knockoutjs.com/) or [AngularJS](https://angularjs.org/) for data binding. In addition, you can use **AngularJS** as an SPA framework and build applications utilizing UI widgets.
