...
* **Breaking Changes**      
Refer to the [breaking changes introduced in v18.2](https://www.devexpress.com/Support/Center/VersionHistory?TechnologyName=DevExtreme&PlatformName=AllPlatforms&ProductName=AllProducts&VersionHistoryItemsType=BreakingChanges&StartBuildName=minor_18_2&EndBuildName=minor_18_2&version-mode=updating-mode). Follow the instructions given for each change to mitigate its possible impact.
