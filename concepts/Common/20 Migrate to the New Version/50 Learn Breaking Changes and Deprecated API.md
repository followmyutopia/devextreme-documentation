We always do our best to minimize the impact an upgrade may have on your projects. Occasionally, however, it is necessary to change our tools' UI, API, or behavior to improve them. Take the following into account to ensure that your app works after upgrading:
