...
* **Breaking Changes**      
Refer to the <a href="https://www.devexpress.com/Support/Center/VersionHistory?TechnologyName=DevExtreme&PlatformName=AllPlatforms&ProductName=AllProducts&VersionHistoryItemsType=BreakingChanges&StartBuildName=minor_19_2&EndBuildName=minor_19_2&version-mode=updating-mode" target="_blank">breaking changes introduced in v19.2</a>. Follow the instructions given for each change to mitigate its possible impact.
