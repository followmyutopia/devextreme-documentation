...
* **Breaking Changes**      
Refer to the [breaking changes introduced in v19.1](https://www.devexpress.com/Support/Center/VersionHistory?TechnologyName=DevExtreme&PlatformName=AllPlatforms&ProductName=AllProducts&VersionHistoryItemsType=BreakingChanges&StartBuildName=minor_19_1&EndBuildName=minor_19_1&version-mode=updating-mode). Follow the instructions given for each change to mitigate its possible impact.
...
You can submit a ticket to our [Support Center](http://www.devexpress.com/Support/Center/Question/List/1) if you experience any problems migrating to the new DevExtreme version.
