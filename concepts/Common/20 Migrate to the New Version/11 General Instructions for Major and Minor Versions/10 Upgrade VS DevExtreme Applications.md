...
- Open your solution/project in Visual Studio. Right click the solution/project to display the context menu and choose **Upgrade DevExtreme Solution to the Latest Version...** (or equivalently **Upgrade DevExtreme Project to the Latest Version...**).
    ...
    ![Invoke Project Converter](Content/images/doc/17_1/DevExtreme/ProjectConverterFromMenu.png)

- Run the **ProjectConverter.exe** program from the folder where DevExtreme is installed. By default, it is located in the "...\Program Files (x86)\DevExpress 17.1\DevExtreme\Tools\" folder.

Specify the path to the project(s) to be upgraded in the **Project folder** text box.

![Project Converter](Content/images/doc/17_1/DevExtreme/ProjectConverter.png)
