First, ensure the [Webpack](http://webpack.github.io/docs/) is installed globally. If not, execute the following command. 
...
To link up the modules to your application using [Webpack](http://webpack.github.io/docs/), begin by defining the [configuration object](http://webpack.github.io/docs/configuration.html).
...
Add [themes](/Documentation/Guide/Themes/Predefined_Themes/) to your application.  
...
You can download [the example](https://github.com/DevExpress/devextreme-examples/tree/18_2/webpack-jquery) from GitHub. To use it, follow the instructions on GitHub. 
...
You can download [the example](https://github.com/DevExpress/devextreme-examples/tree/18_2/webpack-angularjs) from GitHub. To use it, follow the instructions on GitHub.
...
You can download [the example](https://github.com/DevExpress/devextreme-examples/tree/18_2/webpack-knockout) from GitHub. To use it, follow the instructions on GitHub.
