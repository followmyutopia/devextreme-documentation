First, install [jspm](http://jspm.io/) in your application folder. For detailed information on installing, see the [jspm documentation](http://jspm.io/docs/getting-started.html).
...
To link up the modules to your application using [jspm](http://jspm.io/), first add links to the library and then the configuration file to your application. 
...
You can download [the example](https://github.com/DevExpress/devextreme-examples/tree/16_2/jspm-jquery) from GitHub. To use it, follow the instructions on GitHub.  
...
You can download [the example](https://github.com/DevExpress/devextreme-examples/tree/16_2/jspm-angular) from GitHub. To use it, follow the instructions on GitHub.  
...
You can download [the example](https://github.com/DevExpress/devextreme-examples/tree/16_2/jspm-knockout) from GitHub. To use it, follow the instructions on GitHub.  
