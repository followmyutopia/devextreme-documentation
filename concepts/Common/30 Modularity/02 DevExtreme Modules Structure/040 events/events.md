Exposes an object that serves as a namespace for methods used for working with [UI events](/api-reference/10%20UI%20Widgets/UI%20Events/UI%20Events.md '/Documentation/ApiReference/UI_Widgets/UI_Events/').
