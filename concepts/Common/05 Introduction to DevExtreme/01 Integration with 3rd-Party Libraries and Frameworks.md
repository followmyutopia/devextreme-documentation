...
- [Knockout](/Documentation/Guide/Getting_Started/Widget_Basics_-_Knockout/Create_and_Configure_a_Widget/) versions 2.2.3 - 2.3.0 and 3.1.0 - 3.4.0
- [AngularJS](/Documentation/Guide/Getting_Started/Widget_Basics_-_AngularJS/Create_and_Configure_a_Widget/) versions 1.2+ (Refer to the [Migration Guide](http://ng-learn.org/2014/06/Migration_Guide_from_1-2_to1-3/) when using version 1.3 or later)
- [Angular](/Documentation/Guide/Getting_Started/Widget_Basics_-_Angular/Create_and_Configure_a_Widget/) versions 5 and later
- [Vue](https://github.com/DevExpress/devextreme-vue/blob/18.2/README.md) - versions 2.5.16 and later
- [React](/Documentation/Guide/Getting_Started/Widget_Basics_-_React/)
    - [DevExtreme React Wrappers](https://github.com/DevExpress/devextreme-react/blob/18.2/README.md) - versions 16.2 and later
