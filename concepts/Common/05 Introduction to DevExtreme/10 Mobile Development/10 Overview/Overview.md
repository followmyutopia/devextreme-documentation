...
All the presented tools are based on JavaScript, HTML5 and CSS3. When developing DevExtreme applications, you will only need to use JavaScript, HTML and CSS. In addition, you will need basic knowledge of [Knockout](http://knockoutjs.com/)/[Angular](https://angularjs.org/) and [jQuery](http://jquery.com/).