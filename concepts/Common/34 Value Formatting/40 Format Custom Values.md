DevExtreme provides an [API](/Documentation/ApiReference/Common/utils/localization/) for formatting any date or number in your app. The following example shows how to format dates. The [formatDate()](/Documentation/ApiReference/Common/utils/localization/#formatDatevalue_format) method applies a [predefined format]() to a date. A [custom function](/Documentation/Guide/Common/Value_Formatting/#Format_Widget_Values/Custom_Function) or [format string](/Documentation/Guide/Common/Value_Formatting/#Format_Widget_Values/Custom_Format_String) can be applied instead. The result is a string. This string is then converted back to a date using the [parseDate()](/Documentation/ApiReference/Common/utils/localization/#parseDatetext_format) method.
