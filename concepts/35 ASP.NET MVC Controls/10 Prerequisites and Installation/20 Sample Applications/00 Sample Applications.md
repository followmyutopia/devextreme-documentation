DevExtreme ASP.NET MVC Controls come with sample applications that you can find in the C:\Users\Public\Public Documents\DevExpress Demos 19.1\DevExtreme\ASP.NET MVC Controls\ directory.
...
The DevAV folder contains a real-world application demo built using ASP.NET Core MVC 2.0. You can view its online version [here](/Demos/DevAV/).
