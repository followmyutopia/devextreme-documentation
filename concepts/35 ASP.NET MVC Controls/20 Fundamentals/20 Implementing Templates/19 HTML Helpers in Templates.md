...
If the content is dynamic and you need to [access template parameters](/Documentation/Guide/ASP.NET_MVC_Controls/Fundamentals/#Implementing_Templates/Accessing_Template_Parameters), apply the following solution:
