...
Navigation properties are usually deferred and are not loaded automatically together with the owning entity. To load both entities at once, use the [expand](/Documentation/ApiReference/Data_Layer/DataSource/Configuration/#expand) load options extension, specific for ODataStore.
