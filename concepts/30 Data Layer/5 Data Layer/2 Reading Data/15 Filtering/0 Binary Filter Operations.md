...
1. The [getter](/Documentation/Guide/Data_Layer/Data_Layer/#Getters_And_Setters) by which data items are filtered.
...
The second item of the filter expression array is optional. You can specify only the [getter](/Documentation/Guide/Data_Layer/Data_Layer/#Getters_And_Setters) and the value. The default operator is "=".
