...
<!--//highlight-->
        ...
        // Providing data for chart series
		...
		series: [
            ...
            { valueField: 'latinamerica', name: 'Latin America' },
            { valueField: 'northamerica', name: 'North America' }
		],
        
        // Customizing the general appearance of the chart
        palette: 'Vintage',
		legend: { 
            horizontalAlignment: 'center',
            verticalAlignment: 'bottom'
        },
        title: 'World Population by Continents',
        tooltip: {
            enabled: true,
            format: {
                type: 'largeNumber',
