...
!function () {
    ...
    $.extend(wo, {
        ...
        hardwareBackButton: (device.phone && device.platform === "win") || device.platform === "android" || device.platform === "tizen",
        currentWorkout: null,
    ...
    $(function () {
        ...
        wo.app.on("viewShown", onViewShown);
        wo.app.navigationManager.on("navigating", onNavigate);
    ...
    DevExpress.viz.currentTheme(DevExpress.devices.current().platform);
}();