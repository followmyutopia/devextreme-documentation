menuItems = [{
    ...
    items: [
        {
            icon: '/Content/images/doc/18_2/PhoneJS/menus/VSIntegration.png',
            text: 'VS Integration',
            items: [
        ...
        {
            icon: '/Content/images/doc/18_2/PhoneJS/menus/SPAFramework.png',
            text: 'SPA Framework',
            items: [
        ...
        {
            icon: '/Content/images/doc/18_2/PhoneJS/menus/none.png',
            text: 'Demos Inside'
        },
        {
            icon: '/Content/images/doc/18_2/PhoneJS/menus/UIWidgets.png',
            text: 'UI Widgets',
            items: [
                { text: 'Basics' },
        ...
        {
            icon: '/Content/images/doc/18_2/PhoneJS/menus/DataVisualization.png',
        ...
        {
            icon: '/Content/images/doc/18_2/PhoneJS/menus/DataLayer.png',
            text: 'Data Layer'
        },
        {
            icon: '/Content/images/doc/18_2/PhoneJS/menus/none.png',
