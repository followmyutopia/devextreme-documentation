<article data-show="/Content/Applications/16_1/LearningCenter/Data-BoundApplication/step4-1/index.html">
  
- To provide data for the list items using a data service, change the use of the **items** option to the [dataSource](/Documentation/ApiReference/UI_Widgets/dxList/Configuration/#dataSource) option in the **List** configuration object. Bind the **dataSource** option to the **dataSource** field of the ViewModel object.
