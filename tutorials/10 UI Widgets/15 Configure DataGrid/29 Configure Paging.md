...
<article data-show-web="/Content/Applications/16_1/Framework/DataGridTutorial/Step8/grid.html" data-show-first="grid.html">
When paging is used, data from the source is loaded page-by-page, while size of the pages is specified by the **paging** | [pageSize](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/paging/#pageSize) option. To navigate through pages, you can use a [pager](/Documentation/Guide/UI_Widgets/Data_Grid/Visual_Elements/#Pager) and/or scrolling. To configure the pager, use options of the [pager](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/pager/) object. Scrolling options can be set in the [scrolling](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/scrolling/) object.
