...
<article data-show-web="/Content/Applications/16_1/Framework/UseRemoteDataforDataGrid/Step3/grid.html" data-show-first="grid.html">
...
- Assign a configuration object for the DataSource object to the **dataSource** grid option. For details on grid data binding, refer to the [Data Binding](/Documentation/Guide/UI_Widgets/Data_Grid/Data_Binding/) article.
