...
Then, add a .js file to your project and reference it in the head of your HTML file just like you did for the libraries in the previous step. To associate the [DataGrid](/Documentation/ApiReference/UI_Widgets/dxDataGrid/) widget with the created element, call the `dxDataGrid` constructor once the document has been loaded and pass the appropriate configuration object to this constructor, as shown in *grid.js*.
