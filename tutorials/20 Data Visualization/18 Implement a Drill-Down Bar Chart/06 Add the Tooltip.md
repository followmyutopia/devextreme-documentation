<article data-show-web="/Content/Applications/17_2/DataVisualization/Lessons/DrillDownChart/Step5/chart.html" data-show-first="chart.js">
...
Note that there's no need to declare the **tooltip** object in the drill-down level configuration as it will be inherited from the top one.

Although the drill-down **Chart** operates properly, it looks bland and monochrome. In the concluding step, you will learn how to customize the appearance of the chart.
</article>