...
<article data-show-web="/Content/Applications/16_1/DataVisualization/UseRemoteDataforChart/Step1/chart.html" data-show-first="chart.html">
...
If you run the code now, you will see an empty widget indicating that there is no data in it. The next step is to provide data for the **Chart** widget.
