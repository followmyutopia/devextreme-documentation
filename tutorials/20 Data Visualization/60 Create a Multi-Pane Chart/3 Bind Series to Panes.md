<article data-show-web="/Content/Applications/16_1/DataVisualization/Lessons/CreateMultiPaneChart/Step3/chart.html" data-show-first="chart.js">
...
From this tutorial, you discovered how to create a **Chart** widget with several panes. To learn more about panes, see the [Panes](/Documentation/Guide/Data_Visualization/Charts/Chart_Elements/#Panes) topic in the **Chart Elements** guide. For a full list of widget options and methods, proceed to [Chart API Reference](/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/).
