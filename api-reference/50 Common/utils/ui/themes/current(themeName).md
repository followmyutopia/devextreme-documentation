...
... you can switch between them as shown in the code below. Note that you should specify a callback function that repaints all widgets after the theme has been loaded using the [ready(callback)](/Documentation/ApiReference/Common/utils/ui/themes/#readycallback) method.
