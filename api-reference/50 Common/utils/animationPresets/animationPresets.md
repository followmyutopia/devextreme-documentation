...
[note]Stagger-like animations are executed by the [transitionExecutor](/api-reference/50%20Common/utils/TransitionExecutor/TransitionExecutor.md '/Documentation/ApiReference/Common/Utils/TransitionExecutor/') only. They cannot be applied by calling the [animate](/api-reference/50%20Common/utils/fx/animate(element_config).md '/Documentation/ApiReference/Common/Utils/fx/#animateelement_config') method for a particular element.
