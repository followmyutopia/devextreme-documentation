...
---
Instead of a supported template engine, you can use the [DevExpress.setTemplateEngine(options)](/Documentation/ApiReference/Common/utils/#setTemplateEngineoptions) method to define custom functions that compile and render templates.