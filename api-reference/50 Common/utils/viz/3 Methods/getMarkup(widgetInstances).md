...
<!--returnDescription-->
The widgets' SVG markup. Pass it to the <a href="/Documentation/17_1/ApiReference/Common/utils/viz/Methods/#exportFromMarkupmarkup_options">exportFromMarkup(markup, options)</a> method to export the widgets.
<!--/returnDescription-->
