...
---
The string values accepted by the input parameter are: *"iPhone", "iPhone5", "iPhone6", "iPhone6plus", "iPad", "iPadMini", "androidPhone", "androidTablet", "msSurface"* and *"desktop"*. The method can also take on an [object](/Documentation/ApiReference/Common/Object_Structures/device/) containing more detailed information on the current platform.