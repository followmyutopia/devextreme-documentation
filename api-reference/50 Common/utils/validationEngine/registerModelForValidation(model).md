...
---
##### shortDescription
Registers all the [Validator](/api-reference/10%20UI%20Widgets/dxValidator/dxValidator.md '/Documentation/ApiReference/UI_Widgets/dxValidator/') objects extending fields of the specified ViewModel.
