...
<!--fullDescription-->
This object is passed to the **position** configuration option of a widget that overlays the main screen ([LoadPanel](/Documentation/ApiReference/UI_Widgets/dxLoadPanel/), [Popup](/Documentation/ApiReference/UI_Widgets/dxPopup/), [Popover](/Documentation/ApiReference/UI_Widgets/dxPopover/), and [Toast](/Documentation/ApiReference/UI_Widgets/dxToast/)).
