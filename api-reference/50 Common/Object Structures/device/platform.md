...
[note]In addition to the **platform** field, the [version](/api-reference/50%20Common/Object%20Structures/device/version.md '/Documentation/ApiReference/Common/Object_Structures/device/#version') and [deviceType](/api-reference/50%20Common/Object%20Structures/device/deviceType.md '/Documentation/ApiReference/Common/Object_Structures/device/#deviceType') fields can be set when defining a device to be passed to the [DevExpress.devices.current(device)](/Documentation/ApiReference/Common/Utils/devices/Methods/#currentdeviceName) method.