...
---
##### shortDescription
Pushes data changes to the store and notifies the [DataSource](/api-reference/30%20Data%20Layer/DataSource/DataSource.md '/Documentation/ApiReference/Data_Layer/DataSource/').
