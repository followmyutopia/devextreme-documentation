...
![DevExtreme HTML5 JavaScript jQuery Angular Knockout {WidgetName} Filter Panel](/Content/images/doc/18_2/{WidgetName}/visual_elements/filter_panel.png)

Clicking on the filter expression opens the [filter builder]({basewidgetpath}/Configuration/#filterBuilder).

![DevExtreme HTML5 JavaScript jQuery Angular Knockout {WidgetName} Filter Panel](/Content/images/doc/18_2/{WidgetName}/visual_elements/integrated_filter_builder.png)
