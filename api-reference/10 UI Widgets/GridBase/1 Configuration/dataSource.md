...
#include common-dataSource-description with {
    ...
    array_view_demo: "[View Demo](http://js.devexpress.com/Demos/WidgetsGallery/Demo/DataGrid/BatchEditing/)",

    json_view_demo: "[View Demo](http://js.devexpress.com/Demos/WidgetsGallery/Demo/DataGrid/AjaxRequest/)",
    ...
    odata_view_demo: "[View Demo](http://js.devexpress.com/Demos/WidgetsGallery/Demo/DataGrid/ODataService/)", 

    create_store_view_demo: "[View Demo](http://js.devexpress.com/Demos/WidgetsGallery/Demo/DataGrid/WebAPIService/)",

    custom_store_view_demo: "[View Demo](http://js.devexpress.com/Demos/WidgetsGallery/Demo/DataGrid/CustomDataSource/)",
