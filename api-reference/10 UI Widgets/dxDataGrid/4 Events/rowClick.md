...
Indicates whether the clicked row is [selected](/Documentation/Guide/Widgets/DataGrid/Selection/).
<!--/typeFunctionParamDescription1_field11-->
...
The [group index](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/columns/#groupIndex) of the clicked row. This field is useful if the **rowType** field is *'group'*.
<!--/typeFunctionParamDescription1_field13-->
...
The clicked row; provides access to [element-related jQuery operations](http://api.jquery.com/?s=element).
<!--/typeFunctionParamDescription1_field14-->
