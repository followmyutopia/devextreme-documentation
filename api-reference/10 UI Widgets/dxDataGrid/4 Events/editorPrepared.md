...
**-->
<!--d-->Customize after prepare editor<!--/d-->
===========================================================================
<!--type-->EVENT<!--/type-->
...
<!--fp1_field11d-->The current editor as an element.<!--/fp1_field11d-->
<!--fp1_field12d-->Identifies whether or not the editor responds to user actions.<!--/fp1_field12d-->
<!--fp1_field13d-->dataField of column.<!--/fp1_field13d-->
<!--fp1_field14d-->The settings of the row.<!--/fp1_field14d-->
===========================================================================
...
Many grid elements are constructed on editors. For example, the [search panel](/Documentation/Guide/UI_Widgets/Data_Grid/Visual_Elements/#Search_Panel) is constructed on a text box, the [selection column](/Documentation/Guide/UI_Widgets/Data_Grid/Visual_Elements/#Selection_Column) is built on check boxes in full, etc. Obviously, editors are also used to edit cells or rows in a grid. When default editors provided by **DataGrid** do not meet your requirements, you can customize them by changing their settings within the **editorPrepared** event handler. This handler will be called after an editor is created.
