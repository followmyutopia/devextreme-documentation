...
<!--fp1_field5d-->The name of the menu's target ('headerPanel', 'header', 'content' or 'footer')<!--/fp1_field5d-->
<!--fp1_field6d-->The target element (the cell that has been clicked to invoke the context menu)<!--/fp1_field6d-->
<!--fp1_field7d-->The current visible index of the column to which the clicked cell belongs<!--/fp1_field7d-->
<!--fp1_field8d-->The settings of the column to which the clicked cell belongs<!--/fp1_field8d-->
<!--fp1_field9d-->The index of the row to which the clicked cell belongs<!--/fp1_field9d-->
<!--fp1_field10d-->The settings of the row to which the clicked cell belongs<!--/fp1_field10d-->
===========================================================================
