...
<!--shortDescription-->
Specifies the column that must hold the summary item when this item is [displayed in the group footer](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/summary/groupItems/#showInGroupFooter) or [aligned by a column in the group row](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/summary/groupItems/#alignByColumn).
<!--/shortDescription-->
