...
3. The widget does not support remote group paging in case the [expandAll(groupIndex)](/Documentation/17_2/ApiReference/UI_Widgets/dxDataGrid/Methods/#expandAllgroupIndex) method is called.
