<!--id-->dxDataGridColumnButton.onClick<!--/id-->
===========================================================================
...
<!--typeFunctionParamType1_field5-->dxDataGridRowObject<!--/typeFunctionParamType1_field5-->
<!--typeFunctionParamDescription1_field5-->
The properties of the button's row.
<!--/typeFunctionParamDescription1_field5-->
<!--typeFunctionParamName1_field6-->column<!--/typeFunctionParamName1_field6-->
<!--typeFunctionParamType1_field6-->dxDataGridColumn<!--/typeFunctionParamType1_field6-->
