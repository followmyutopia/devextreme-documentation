...
<!--shortDescription-->
Specifies a custom template for the [header](/Documentation/Guide/Widgets/DataGrid/Visual_Elements/#Grid_Columns/Configuring_Column_Headers) of a grid column.
<!--/shortDescription-->
...
- **columnIndex**		
Contains the index of a column that the current header belongs to. For more information on how this index is calculated, refer to the [Calculating the Column Index](/Documentation/Guide/Widgets/DataGrid/Visual_Elements/#Grid_Columns/Calculating_the_Column_Index) topic.   
- **column**		
