...
<!--shortDescription-->
Specifies whether grid records can be sorted by a specific column at runtime. Setting this option makes sense only when the [sorting mode](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/sorting/#mode) differs from *none*.
<!--/shortDescription-->
