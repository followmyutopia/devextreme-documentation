...
<!--shortDescription-->
A function that is executed when a cell is double-clicked or double-tapped. Executed before [onRowDblClick](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/#onRowDblClick).
<!--/shortDescription-->
...
<!--typeFunctionParamType1_field11-->dxDataGridColumn<!--/typeFunctionParamType1_field11-->
