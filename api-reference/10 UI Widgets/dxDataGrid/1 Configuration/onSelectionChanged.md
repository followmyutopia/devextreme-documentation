...
<!--shortDescription-->
A handler for the [selectionChanged](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Events/#selectionChanged) event.
<!--/shortDescription-->
...
To retrieve data by using a key, use the [byKey(key)](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Methods/#byKeykey) method.
