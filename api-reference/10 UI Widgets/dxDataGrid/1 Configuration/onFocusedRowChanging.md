...
<!--/typeFunctionParamDescription1_field1-->
<!--typeFunctionParamName1_field2-->prevRowIndex<!--/typeFunctionParamName1_field2-->
<!--typeFunctionParamType1_field2-->Number<!--/typeFunctionParamType1_field2-->
<!--typeFunctionParamDescription1_field2-->

<!--/typeFunctionParamDescription1_field2-->
<!--typeFunctionParamName1_field3-->newRowIndex<!--/typeFunctionParamName1_field3-->
...
<!--/typeFunctionParamDescription1_field5-->
<!--typeFunctionParamName1_field6-->rows<!--/typeFunctionParamName1_field6-->
<!--typeFunctionParamType1_field6-->Array<dxDataGridRowObject><!--/typeFunctionParamType1_field6-->
