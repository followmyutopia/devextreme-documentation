...
<!--fullDescription-->
To provide data for a grid, use the **dataSource** option. This option accepts one of the following.

- Array of objects      
 A simple JavaScript array containing a collection of plain objects. The fields of each object will be used to provide data for corresponding grid columns.
...
For more information on how to implement a data source and bind it to your grid, refer to the [Data Binding](/Documentation/Guide/UI_Widgets/Data_Grid/Data_Binding/) topic.
<!--/fullDescription-->