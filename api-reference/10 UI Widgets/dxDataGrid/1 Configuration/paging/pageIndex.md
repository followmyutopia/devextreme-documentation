...
[note] The page index is one less than the page number displayed by the [pager](/Documentation/Guide/Widgets/DataGrid/Visual_Elements/#Pager). Thus, the first page has 0 index, the second - 1, etc.
