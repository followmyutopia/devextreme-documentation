...
<!--shortDescription-->
A handler for the [rowInserted](/Documentation/ApiReference/UI_Widgets/dxDataGrid/Events/#rowInserted) event.
<!--/shortDescription-->
...
[note] In [batch edit mode](/Documentation/Guide/UI_Widgets/Data_Grid/Data_Editing/#Editing_in_UI/Batch_Mode), when several rows have been inserted, the **onRowInserted** function will be executed for each row individually.
