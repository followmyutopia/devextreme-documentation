...
<!--shortDescription-->
Specifies which data field provides keys for data items. Applies only if data is a [simple array](/Documentation/Guide/Widgets/DataGrid/Data_Binding/Simple_Array/Array_Only/).
<!--/shortDescription-->
