...
Specifies the delay between the moment a user stops entering a filter value in the [filter row](/Documentation/Guide/Widgets/DataGrid/Visual_Elements/#Filter_Row) or [search panel](/Documentation/Guide/Widgets/DataGrid/Visual_Elements/#Search_Panel) and the moment this value is applied.
<!--/typeFunctionParamDescription1_field7-->
