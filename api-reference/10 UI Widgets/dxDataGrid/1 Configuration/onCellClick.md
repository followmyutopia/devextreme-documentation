...
<!--fp1d-->Information about the event.<!--/fp1d-->
<!--fp1_field1d-->Returns the component instance<!--/fp1_field1d-->
<!--fp1_field2d-->Returns an html representing the component<!--/fp1_field2d-->
<!--fp1_field3d-->Returns the data that is available for binding against the element<!--/fp1_field3d-->
<!--fp1_field4d-->The jQuery event.<!--/fp1_field4d-->
<!--fp1_field5d-->The object of a data source represented by the row to which the clicked cell belongs.<!--/fp1_field5d-->
<!--fp1_field6d-->Key of the row<!--/fp1_field6d-->
<!--fp1_field7d-->The value of the clicked cell as it is specified in a data source.<!--/fp1_field7d-->
<!--fp1_field8d-->The value displayed by the clicked cell.<!--/fp1_field8d-->
<!--fp1_field9d-->The value of the clicked cell in a string format.<!--/fp1_field9d-->
<!--fp1_field10d-->The current visible index of the column to which the clicked cell belongs.<!--/fp1_field10d-->
<!--fp1_field11d-->The settings of the column to which the clicked cell belongs<!--/fp1_field11d-->
<!--fp1_field12d-->The index of the row to which the clicked cell belongs.<!--/fp1_field12d-->
<!--fp1_field13d-->The type of the row to which the clicked cell belongs.<!--/fp1_field13d-->
<!--fp1_field14d-->The clicked cell as an element.<!--/fp1_field14d-->
<!--fp1_field15d-->The settings of the row to which the clicked cell belongs.<!--/fp1_field15d-->
===========================================================================
...
<!--fullDescription-->
The **cellClick** event fires when a user clicks a [grid cell](/Documentation/Guide/UI_Widgets/Data_Grid/Visual_Elements/#Grid_Cells). When implementing a handling function for this event, use the object passed to this function as its parameter. Among the fields of this object, you can find data relating to the clicked cell.
