...
- **grouping**.[texts](/api-reference/10%20UI%20Widgets/dxDataGrid/1%20Configuration/grouping/texts/texts.md '/Documentation/ApiReference/UI_Widgets/dxDataGrid/Configuration/grouping/texts/') - customizes the context menu items.