...
When configuring the widget using [ASP.NET MVC Wrappers](/Documentation/Guide/ASP.NET_MVC_Wrappers/Fundamentals/), specify this option using the `GridGroupingExpandMode` enum. This enum accepts the following values: `ButtonClick` and `RowClick`.
<!--/fullDescription-->