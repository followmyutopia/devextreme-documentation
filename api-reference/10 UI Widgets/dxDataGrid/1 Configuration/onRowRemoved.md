...
[note] In [batch edit mode](/Documentation/Guide/UI_Widgets/Data_Grid/Data_Editing/#Editing_in_UI/Batch_Mode), when several rows have been removed, the **onRowRemoved** function will be executed for each row individually.
