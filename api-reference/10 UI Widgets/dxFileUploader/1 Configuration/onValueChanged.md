...
**-->
<!--d-->An action performed when the value has been changed. 'value' argument specifies the selected widget files. 'previousValue' argument specifies the previous widget selected files.<!--/d-->
...
<!--fp1_field4d-->Returns the widget's selected files<!--/fp1_field4d-->
<!--fp1_field5d-->Returns the previous widget's selected files<!--/fp1_field5d-->
