...
**-->
<!--d-->An action performed after group of items rendered.<!--/d-->
...
<!--fp1_field4d-->Returns an object representing the group<!--/fp1_field4d-->
<!--fp1_field5d-->Returns an HTML element representing the group<!--/fp1_field5d-->
<!--fp1_field6d-->Returns a number representing the group index<!--/fp1_field6d-->
===========================================================================
...
<!--/typeFunctionParamDescription1_field4-->
<!--typeFunctionParamName1_field5-->groupElement<!--/typeFunctionParamName1_field5-->
