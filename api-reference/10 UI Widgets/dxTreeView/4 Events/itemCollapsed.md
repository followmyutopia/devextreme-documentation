...
**-->
<!--d-->An action performed when a widget item is collapsed.<!--/d-->
===========================================================================
<!--type-->EVENT<!--/type-->
...
The collapsed item <a href="Documentation/Guide/UI_Widgets/UI_Widget_Categories/Collection_Container_Widgets/#TreeViewNodes">node</a>.
<!--/typeFunctionParamDescription1_field8-->
