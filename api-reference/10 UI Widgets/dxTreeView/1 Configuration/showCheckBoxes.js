...
var myViewModel = {
    ...
    checkBoxesVisible: ko.observable(false)
}
...
$("#showCheckBoxesSelector").dxSwitch({
    value: false,
    onValueChanged: function (e) {
        $("#myTreeView").dxTreeView("instance").option("showCheckBoxes", e.value);
    }
});
//<!--/@jQuery-->