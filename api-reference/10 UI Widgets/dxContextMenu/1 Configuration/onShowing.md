...
**-->
<!--d-->Action raises before context menu will be shown<!--/d-->
...
<!--fp1_field4d-->Indicates whether to cancel showing the overlay<!--/fp1_field4d-->
===========================================================================

<!--shortDescription-->
A handler for the [showing](/Documentation/ApiReference/UI_Widgets/dxContextMenu/Events/#showing) event.
<!--/shortDescription-->
