...
**-->
<!--d-->Action raises after context menu will be hidden<!--/d-->
===========================================================================
<!--type-->EVENT<!--/type-->
...
<!--fullDescription-->
Instead, you can use the [onHidden](/Documentation/ApiReference/UI_Widgets/dxContextMenu/Configuration/#onHidden) option to handle the event.
