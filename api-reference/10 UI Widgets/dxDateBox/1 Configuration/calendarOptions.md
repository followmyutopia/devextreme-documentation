...
---
You can specify most of the [Calendar options](/api-reference/10%20UI%20Widgets/dxCalendar/1%20Configuration/Configuration.md '/Documentation/ApiReference/UI_Widgets/dxCalendar/Configuration/') in this object except those listed below. These options are overridden by their **DateBox** counterparts.
