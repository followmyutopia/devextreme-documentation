...
**-->
<!--d-->A Date object, a number or a string specifying the date and time currently selected via the datebox. String is accepted only in the following formats: 'yyyy/MM/dd', 'yyyy/MM/dd HH:mm:ss'.<!--/d-->
===========================================================================
