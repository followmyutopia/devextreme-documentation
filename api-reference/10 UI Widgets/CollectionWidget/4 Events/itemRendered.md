...
**-->
<!--d-->An action performed after a widget item is rendered. 'itemElement' argument specifies the rendered item element. 'itemData' argument specifies the rendered item data.<!--/d-->
===========================================================================
<!--type-->EVENT<!--/type-->
