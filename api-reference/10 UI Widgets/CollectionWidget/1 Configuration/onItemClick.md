...
**-->
<!--d-->An action performed when a widget item is clicked. 'itemElement' argument specifies the clicked item element. 'itemData' argument specifies the clicked item data.<!--/d-->
...
<!--shortDescription-->
A handler for the [itemClick]({basewidgetpath}/Events/#itemClick) event.
<!--/shortDescription-->
