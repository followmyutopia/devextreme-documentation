...
**-->
<!--d-->An action performed when a widget item is holded or clicked by right mouse button. 'itemElement' argument specifies the clicked item element. 'itemData' argument specifies the clicked item data.<!--/d-->
