...
**-->
<!--d-->An action performed when a widget item is holded. 'itemElement' argument specifies the clicked item element. 'itemData' argument specifies the clicked item data.<!--/d-->
...
<!--shortDescription-->
A handler for the [itemHold]({basewidgetpath}/Events/#itemHold) event.
<!--/shortDescription-->
