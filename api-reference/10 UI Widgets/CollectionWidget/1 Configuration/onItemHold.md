...
<!--EventForAction-->CollectionWidget.itemHold<!--/EventForAction-->
===========================================================================
...
<!--shortDescription-->
A function that is executed when a collection item has been held for a [specified period]({basewidgetpath}/Configuration/#itemHoldTimeout).
<!--/shortDescription-->
