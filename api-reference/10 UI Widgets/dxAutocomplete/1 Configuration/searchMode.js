...
var myViewModel = {
    ...
    searchModes: ["contains", "startswith"],
...
myApp.controller("demoController", function ($scope) {
    ...
    $scope.searchModes = ["contains", "startswith"];
    $scope.currentMode = "contains";
    //Loads json data and passes it to the DataSource
    $.get("/Content/data/countries.txt", function (data) {
        for (var i = 0; i < data.length; i++) {
...
$("#modeSelector").dxSelectBox({
    ...
    onValueChanged: function (e) {
        $("#myAutocomplete").dxAutocomplete("instance").option("searchMode", e.value);
    }
});
//Loads json data and passes it to the DataSource
$.get("/Content/data/countries.txt", function (data) {
