...
**-->
<!--d-->A template name or a template container or a function returning one of them, which is used to render content of items. Or a function creating the item content. Has following signature itemTemplate(itemData, itemIndex, itemElement). Returns htmlString or Element or jQuery representing content of the item.<!--/d-->
===========================================================================
<!--default-->'item'<!--/default-->
<!--type-->template<!--/type-->
<!--fp1d-->An object representing the item content to be rendered.<!--/fp1d-->
<!--fp2d-->The index of the item to be rendered.<!--/fp2d-->
<!--fp3d-->An HTML element containing the rendered item content.<!--/fp3d-->
<!--frd-->A template name or a template container. Or an HTML string, Element, or jQuery object representing the rendered item content.<!--/frd-->
===========================================================================
...
So, in **Knockout approach**, you can bind template elements to the item object fields directly. To access another binding context within an item template, use the [Knockout](http://knockoutjs.com/documentation/binding-context.html) binding variables.
