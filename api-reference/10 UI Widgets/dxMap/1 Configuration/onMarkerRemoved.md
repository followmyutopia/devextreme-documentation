...
**-->
<!--d-->An action performed when the marker is added to the widget. 'options' argument specifies the removed marker options.<!--/d-->
...
<!--fp1_field4d-->Returns the object that defines the currently removed marker in the 'markers' array<!--/fp1_field4d-->
===========================================================================
