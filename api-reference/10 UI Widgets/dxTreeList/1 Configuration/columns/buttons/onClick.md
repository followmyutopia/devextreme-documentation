<!--id-->dxTreeListColumnButton.onClick<!--/id-->
===========================================================================
...
<!--/typeFunctionParamDescription1_field4-->
<!--typeFunctionParamName1_field5-->row<!--/typeFunctionParamName1_field5-->
<!--typeFunctionParamType1_field5-->dxTreeListRowObject<!--/typeFunctionParamType1_field5-->
<!--typeFunctionParamDescription1_field5-->
The properties of the button's row.
<!--/typeFunctionParamDescription1_field5-->
<!--typeFunctionParamName1_field6-->column<!--/typeFunctionParamName1_field6-->
<!--typeFunctionParamType1_field6-->dxTreeListColumn<!--/typeFunctionParamType1_field6-->
