<!--id-->dxTreeListColumnButton.template<!--/id-->
===========================================================================
<!--type-->template<!--/type-->
===========================================================================
...
The container of the cell that should display the button. It is an [HTML Element](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement) or a [jQuery Element](http://api.jquery.com/Types/#jQuery) when you use jQuery.
<!--/typeFunctionParamDescription1-->
...
<!--typeFunctionParamType2_field1-->dxTreeList<!--/typeFunctionParamType2_field1-->
...
The index of the cell's column. <br/> Refer to [Column and Row Indexes](/Documentation/Guide/Widgets/TreeList/Columns/Column_and_Row_Indexes/) for more information.
<!--/typeFunctionParamDescription2_field4-->
<!--typeFunctionParamName2_field5-->column<!--/typeFunctionParamName2_field5-->
<!--typeFunctionParamType2_field5-->dxTreeListColumn<!--/typeFunctionParamType2_field5-->
...
The index of the cell's row. Begins with 0 on each page. Group rows are included. <br/> Refer to [Column and Row Indexes](/Documentation/Guide/Widgets/TreeList/Columns/Column_and_Row_Indexes/) for more information.
<!--/typeFunctionParamDescription2_field6-->
...
<!--typeFunctionParamType2_field8-->dxTreeListRowObject<!--/typeFunctionParamType2_field8-->
