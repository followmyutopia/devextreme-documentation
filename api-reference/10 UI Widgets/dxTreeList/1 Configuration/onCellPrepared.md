...
Use to get the value with the applied <a href="/Documentation/17_1/ApiReference/UI_Widgets/dxTreeList/Configuration/columns/#format">format</a>. 
<!--/typeFunctionParamDescription1_field8-->
...
The properties of the row. Available if the <b>rowType</b> is <i>'data'</i>, <i>'detail'</i> or <i>'detailAdaptive'</i>.
<!--/typeFunctionParamDescription1_field13-->
