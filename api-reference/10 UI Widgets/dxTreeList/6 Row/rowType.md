...
- *"filter"*  
    The [filter row](/api-reference/10%20UI%20Widgets/dxTreeList/1%20Configuration/filterRow/filterRow.md '/Documentation/ApiReference/UI_Widgets/dxTreeList/Configuration/filterRow/').
