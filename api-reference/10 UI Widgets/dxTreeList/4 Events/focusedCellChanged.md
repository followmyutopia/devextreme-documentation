<!--id-->dxTreeList.focusedCellChanged<!--/id-->
===========================================================================
<!--type-->eventType<!--/type-->
===========================================================================
...
<!--fullDescription-->
Main article: [onFocusedCellChanged](/Documentation/ApiReference/UI_Widgets/dxTreeList/Configuration/#onFocusedCellChanged)
