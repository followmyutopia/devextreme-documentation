...
**-->
<!--d-->An action performed at the end of a resize.<!--/d-->
===========================================================================
<!--type-->EVENT<!--/type-->
...
<!--fullDescription-->
Instead, you can use the [onResizeEnd](/Documentation/ApiReference/UI_Widgets/dxResizable/Configuration/#onResizeEnd) option to handle the event.
