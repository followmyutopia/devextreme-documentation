...
**-->
<!--d-->An action performed at the start of a resize.<!--/d-->
===========================================================================
<!--type-->EVENT<!--/type-->
...
<!--fp1_field5d-->Returns the width of the widget<!--/fp1_field5d-->
<!--fp1_field6d-->Returns the height of the widget<!--/fp1_field6d-->
===========================================================================
...
<!--fullDescription-->
Instead, you can use the [onResizeStart](/Documentation/ApiReference/UI_Widgets/dxResizable/Configuration/#onResizeStart) option to handle the event.
