...
**-->
<!--d-->An action performed when a widget resize is performed.<!--/d-->
...
<!--shortDescription-->
A handler for the [resize](/Documentation/ApiReference/UI_Widgets/dxResizable/Events/#resize) event.
<!--/shortDescription-->
