...
---
##### shortDescription
Specifies whether or not to show the action sheet within a [Popover](/api-reference/10%20UI%20Widgets/dxPopover/dxPopover.md '/Documentation/ApiReference/UI_Widgets/dxPopover/') widget.
