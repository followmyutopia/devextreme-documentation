...
**-->
<!--d-->Action raises before context menu will be hiding. 'rootItem' argument specifies the parent menu item of submenu<!--/d-->
...
<!--fp1_field5d-->Indicates whether to cancel hiding the context menu<!--/fp1_field5d-->
===========================================================================
