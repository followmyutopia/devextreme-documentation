...
**-->
<!--d-->The event for handling hardware agnostic pointer input from devices like a mouse, pen, or touchscreen. The event triggers when a pointing device is moved out of the hit test boundaries of an element or after firing the pointerup event for a device that does not support hover or after firing the pointercancel event or when a pen stylus leaves the hover range detectable by the digitizer. (See more: http://www.w3.org/TR/pointerevents/#the-pointerout-event).<!--/d-->
===========================================================================
