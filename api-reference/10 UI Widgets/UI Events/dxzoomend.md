...
**-->
<!--d-->The event for handling when zoom gesture is finished.<!--/d-->
<!--dep-->Use 'dxpinchend' event instead.<!--/dep-->
===========================================================================
...
<!--deprecated-->
Use the [dxpinchend](/Documentation/ApiReference/UI_Widgets/UI_Events/#dxpinchend) event instead.
<!--/deprecated-->
