...
**-->
<!--d-->A template name or a template container or a function returning one of them, which is used to render tags. Might be a function creating the tag. Has following signature tagTemplate(itemData, itemElement). Returns htmlString or Element or jQuery representing content of the item.<!--/d-->
===========================================================================
<!--default-->'tag'<!--/default-->
<!--type-->template<!--/type-->
<!--fp1d-->An object representing the item to be rendered.<!--/fp1d-->
<!--fp2d-->An HTML element containing the rendered item.<!--/fp2d-->
<!--frd-->A template name or a template container. Or an HTML string, Element, or jQuery object representing the rendered tag.<!--/frd-->
===========================================================================
