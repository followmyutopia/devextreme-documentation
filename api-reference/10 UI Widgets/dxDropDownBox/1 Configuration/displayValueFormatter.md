...
The following code demonstrates how to change separators from commas to semicolons by using the **displayValueFormatter** function. You can try it if you copy this code to the [Multiple Selection demo](http://js.devexpress.com/Demos/WidgetsGallery/Demo/DropDownBox/MultipleSelection/):
