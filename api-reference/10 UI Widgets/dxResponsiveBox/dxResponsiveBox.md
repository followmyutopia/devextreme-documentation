...
**-->
<!--d-->Responsive box widget.<!--/d-->
===========================================================================
<!--module--><a href="/Documentation/16_1/Guide/Common/Modularity/#Common_Modularity_DevExtreme_Modules_Structure_ui_responsive_box">ui/responsive_box</a><!--/module-->
<!--type-->object<!--/type-->
...
Refer to the [Layout Widgets](/Documentation/Guide/UI_Widgets/UI_Widget_Categories/Layout_Widgets/#List_of_Layout_Widgets/dxResponsiveBox) guide for more information on working with the **Box** widget.
