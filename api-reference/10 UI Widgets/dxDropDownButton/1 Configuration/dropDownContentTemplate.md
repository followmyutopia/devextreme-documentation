...
---
The drop-down field contains the [List](http://js.devexpress.com/Demos/WidgetsGallery/Demo/List/ListEditingAndAPI/) widget. Implement this template to replace the widget with custom content. The following restrictions apply when the template is specified:
