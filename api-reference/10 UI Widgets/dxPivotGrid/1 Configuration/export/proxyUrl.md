...
The sample proxy implementation for ASPx-based and PHP-based web servers is presented in the [Client-Side Exporting](/concepts/05%20Widgets/DataGrid/70%20Client-Side%20Exporting/Client-Side%20Exporting.md '/Documentation/Guide/Widgets/DataGrid/Client-Side_Exporting/') article.