...
Assign **true** to the [allowFiltering](/api-reference/10%20UI%20Widgets/dxPivotGrid/1%20Configuration/allowFiltering.md '/Documentation/ApiReference/UI_Widgets/dxPivotGrid/Configuration/#allowFiltering') option to make the icons visible. To customize a specific field's header filter, use the field's [headerFilter](/api-reference/30%20Data%20Layer/PivotGridDataSource/1%20Configuration/fields/headerFilter/headerFilter.md '/Documentation/ApiReference/Data_Layer/PivotGridDataSource/Configuration/fields/headerFilter/') object.
...
#####See Also#####
- [Filtering](/concepts/05%20Widgets/PivotGrid/080%20Filtering/Filtering.md '/Documentation/Guide/Widgets/PivotGrid/Filtering/')