...
**-->
<!--d-->An action performed when the editor value changes. 'value' argument specifies the current widget value. 'previousValue' argument specifies the previous widget value.<!--/d-->
