...
**-->
<!--d-->An action performed when an appointment is deleted.<!--/d-->
...
<!--fp1_field4d-->Deleted appointment data<!--/fp1_field4d-->
<!--fp1_field5d-->Information on the occurred error during deleting.<!--/fp1_field5d-->
===========================================================================
