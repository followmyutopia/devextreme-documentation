...
So, in **Knockout approach**, you can bind template elements to the resource object fields. To access another binding context within a resource template, use [Knockout](http://knockoutjs.com/documentation/binding-context.html) binding variables.
