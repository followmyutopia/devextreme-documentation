...
**-->
<!--d-->An action performed when the widget content is ready.<!--/d-->
===========================================================================
<!--hidden--><!--/hidden-->
<!--type-->EVENT<!--/type-->
...
<!--fullDescription-->
Instead, you can use the [onContentReady]({basewidgetpath}/Configuration/#onContentReady) option to handle the event.
