...
**-->
<!--d-->An action performed when a widget title is clicked. 'titleElement' argument specifies the clicked title element. 'titleData' argument specifies the clicked title data.<!--/d-->
===========================================================================
<!--type-->EVENT<!--/type-->
