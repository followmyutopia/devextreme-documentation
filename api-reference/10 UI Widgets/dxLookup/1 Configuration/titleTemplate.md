...
**-->
<!--d-->A template name or a template container or a function returning one of them, which is used to render popup title. Or a function creating the title item. Has following signature titleTemplate(titleElement). Returns htmlString or Element or jQuery representing content of the title item.<!--/d-->
===========================================================================
