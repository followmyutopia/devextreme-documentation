<!--id-->dxHtmlEditorMention.template<!--/id-->
===========================================================================
...
<!--/fullDescription-->
<!--typeFunctionParamName1-->mentionData<!--/typeFunctionParamName1-->
<!--typeFunctionParamType1-->Object<!--/typeFunctionParamType1-->
<!--typeFunctionParamDescription1-->
The current mention's data.
<!--/typeFunctionParamDescription1-->
<!--typeFunctionParamName1_field1-->marker<!--/typeFunctionParamName1_field1-->
...
<!--/typeFunctionParamDescription1_field1-->
<!--typeFunctionParamName1_field2-->id<!--/typeFunctionParamName1_field2-->
<!--typeFunctionParamType1_field2-->String | Number<!--/typeFunctionParamType1_field2-->
...
The mention's container. It is an [HTML Element](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement) or a [jQuery Element](http://api.jquery.com/Types/#jQuery) when you use jQuery.
<!--/typeFunctionParamDescription2-->
