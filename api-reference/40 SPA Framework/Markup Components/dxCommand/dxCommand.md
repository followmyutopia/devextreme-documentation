...
**-->
<!--d-->Command markup options<!--/d-->
===========================================================================
<!--module--><a href="/Documentation/16_1/Guide/Common/Modularity/#Common_Modularity_DevExtreme_Modules_Structure_framework_command">framework/command</a><!--/module-->
<!--type-->object<!--/type-->
<!--lib-->
