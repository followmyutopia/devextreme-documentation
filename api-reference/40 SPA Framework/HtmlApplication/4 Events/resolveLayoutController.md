...
A collection of the layout controllers that are registered in the application and appropriate for the current device (its platform and form). Each object exposes the "controller" field and the fields presenting the <a href="/Documentation/17_1/ApiReference/Common_Object_Structures/device">device</a> object fields.
<!--/typeFunctionParamDescription1_field3-->
