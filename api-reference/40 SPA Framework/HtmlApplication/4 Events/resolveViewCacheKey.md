...
**-->
<!--d-->Fired when an application decides if it's needed to create a new instance of view or use one from the view cache.<!--/d-->
===========================================================================
<!--type-->EVENT<!--/type-->
<!--fp1d-->Provides function parameters<!--/fp1d-->
<!--fp1_field1d-->The key value that is generated by default.<!--/fp1_field1d-->
<!--fp1_field2d-->Information about the target item in the application navigation history.<!--/fp1_field2d-->
<!--fp1_field3d-->Object represents the target URI parameters produced by application's router.<!--/fp1_field3d-->
===========================================================================
