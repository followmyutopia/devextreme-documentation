...
To navigate back to a previous view, use the [back](/Documentation/ApiReference/SPA_Framework/HtmlApplication/Methods/#back) method, or define a [command](/Documentation/17_2/Guide/SPA_Framework/Views_and_Layouts/#Add_Commands_to_Views) with the [onExecute](/Documentation/ApiReference/SPA_Framework/Markup_Components/dxCommand/Configuration/#onExecute) option set to the '#_back' method. For details, refer to the [Navigate Back in Mobile Apps](/Documentation/17_2/Guide/SPA_Framework/Navigation_and_Routing/#Navigate_Back_in_Mobile_Apps) and [Navigation in Web Apps](/Documentation/17_2/Guide/SPA_Framework/Navigation_and_Routing/#Navigation_in_Web_Apps) topics.
<!--/fullDescription-->