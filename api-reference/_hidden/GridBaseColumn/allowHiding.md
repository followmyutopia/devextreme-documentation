...
---
##### shortDescription
Specifies whether a user can hide the column using the column chooser at runtime. Applies only if **columnChooser**.[enabled](/api-reference/10%20UI%20Widgets/GridBase/1%20Configuration/columnChooser/enabled.md '{basewidgetpath}/Configuration/columnChooser/#enabled') is **true**.
