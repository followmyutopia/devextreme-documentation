...
- **columns[]**.[editorOptions](/Documentation/ApiReference/UI_Widgets/dxTreeList/Configuration/columns/#editorOptions)         
Use it to specify the default editor's options (except **onValueChanged**).

- [onEditorPreparing](/Documentation/ApiReference/UI_Widgets/dxTreeList/Configuration/#onEditorPreparing)         
Use it to:
...
[note] If you implement two-way data binding in your template, set [twoWayBindingEnabled](/Documentation/ApiReference/UI_Widgets/dxTreeList/Configuration/#twoWayBindingEnabled) to **false** to disable this feature's built-in implementation.
