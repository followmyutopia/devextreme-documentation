...
If the lookup data source contains objects, specify the [valueExpr](/api-reference/10%20UI%20Widgets/dxFilterBuilder/5%20Field/lookup/valueExpr.md '/Documentation/ApiReference/UI_Widgets/dxFilterBuilder/Configuration/fields/lookup/#valueExpr') and [displayExpr](/api-reference/10%20UI%20Widgets/dxFilterBuilder/5%20Field/lookup/displayExpr.md '/Documentation/ApiReference/UI_Widgets/dxFilterBuilder/Configuration/fields/lookup/#displayExpr') options in addition to the **dataSource**.
