...
**-->
<!--d-->Occurs when area selection state is changed (argument - Proxy object for the area)<!--/d-->
<!--dep-->Use the 'onSelectionChanged' option instead<!--/dep-->
...
<!--fp1_field3d-->The area that was selected or unselected.<!--/fp1_field3d-->
===========================================================================
