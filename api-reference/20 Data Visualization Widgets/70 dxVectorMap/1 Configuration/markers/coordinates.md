...
<!--fullDescription-->
This option accepts an array of two values: the first is the longitude, the second is the latitude of a map marker. You can obtain the coordinates of a map marker from code using the [coordinates()](/Documentation/ApiReference/Data_Visualization_Widgets/dxVectorMap/Map_Elements/Marker/Methods/#coordinates) method.
