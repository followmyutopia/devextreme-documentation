<!--id-->dxVectorMap.Options.layers.label<!--/id-->
===========================================================================
<!--type-->Object<!--/type-->
===========================================================================
...
<!--fullDescription-->
A marker label is a text that accompanies a [map marker](/Documentation/Guide/Widgets/VectorMap/Visual_Elements/#Markers). Usually, a marker label displays the name of a certain geographical point.
