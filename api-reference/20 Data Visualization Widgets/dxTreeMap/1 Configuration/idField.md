<!--id-->dxTreeMap.Options.idField<!--/id-->
===========================================================================
...
<!--shortDescription-->
Specifies the name of the data source field that provides IDs for items. Applies to plain [data sources](/Documentation/ApiReference/Data_Visualization_Widgets/dxTreeMap/Configuration/#dataSource) only.
<!--/shortDescription-->
