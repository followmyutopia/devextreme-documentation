...
---
Each tile or the header of a group contains a text label identifying what this tile or group represents. You can change the font of tile labels or their visibility using the fields of the **tile**.**label** object. The same properties of group labels can be changed using the **group**.[label](/api-reference/20%20Data%20Visualization%20Widgets/dxTreeMap/1%20Configuration/group/label/label.md '/Documentation/ApiReference/Data_Visualization_Widgets/dxTreeMap/Configuration/group/label/') object.
