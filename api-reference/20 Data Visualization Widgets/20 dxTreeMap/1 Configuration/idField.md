...
**-->
<!--d-->set field of id of element (only for plain dataSource)<!--/d-->
===========================================================================
...
<!--shortDescription-->
Specifies the name of the data source field that provides IDs for items. Applies to flat [data sources](/Documentation/ApiReference/Data_Visualization_Widgets/dxTreeMap/Configuration/#dataSource) only.
<!--/shortDescription-->
