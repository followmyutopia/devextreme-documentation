...
When configuring the widget using [ASP.NET MVC Wrappers](/Documentation/Guide/ASP.NET_MVC_Wrappers/Fundamentals/), you can specify this option using the `TreeMapColorizerType` enum. This enum accepts the following values: `Discrete`, `Gradient`, `Range` and `None`.
<!--/fullDescription-->