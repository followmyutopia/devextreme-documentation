...
<!--fullDescription-->
When configuring the widget using [ASP.NET MVC Wrappers](/Documentation/Guide/ASP.NET_MVC_Wrappers/Fundamentals/), specify this option using the `PieChartLabelPosition` enum. This enum accepts the following values: `Outside`, `Inside` and `Columns`.
