...
<!--shortDescription-->
Aligns items in the last column or row (depending on the legend's [orientation]({basewidgetpath}/Configuration/legend#orientation)). Applies when legend items are not divided into columns or rows equally.
<!--/shortDescription-->
