...
<!--shortDescription-->
Specifies the value to be raised to a power when generating ticks for a [logarithmic value axis](/Documentation/ApiReference/Data_Visualization_Widgets/dxRangeSelector/Configuration/chart/valueAxis/#type).
<!--/shortDescription-->
...
In addition, you can use a [logarithmic scale](/Documentation/ApiReference/Data_Visualization_Widgets/dxRangeSelector/Configuration/scale/#type) with a required [logarithm base](/Documentation/ApiReference/Data_Visualization_Widgets/dxRangeSelector/Configuration/scale/#logarithmBase) to display series arguments.
<!--/fullDescription-->