...
<!--acceptValues-->'logarithmic' | 'continuous'<!--/acceptValues-->
<!--type-->string<!--/type-->
===========================================================================
...
When configuring the widget using [ASP.NET MVC Wrappers](/Documentation/Guide/ASP.NET_MVC_Wrappers/Fundamentals/), specify this option using the `RangeSelectorChartAxisScaleType` enum. This enum accepts the following values: `Logarithmic` and `Continuous`.
<!--/fullDescription-->