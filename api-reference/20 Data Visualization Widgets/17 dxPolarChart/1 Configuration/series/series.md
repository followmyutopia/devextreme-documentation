...
<!--shortDescription-->
Specifies options for **PolarChart** widget [series](/Documentation/Guide/Data_Visualization/Charts/PolarChart_Elements/#Series).
<!--/shortDescription-->

<!--fullDescription-->
A series represents a grouping of related data points. The most important characteristic of a series is its type, which determines a particular visual representation of data. You can find more details on each series type in the corresponding topics in the [Series](/Documentation/Guide/Data_Visualization/Charts/PolarChart_Elements/#Series) help section.
