...
**-->
<!--d-->resolve labels overlapping<!--/d-->
===========================================================================
...
<!--shortDescription-->
Specifies how the chart must behave when [series point labels](/Documentation/Guide/Data_Visualization/Charts/PolarChart_Elements/#Series_Point_Labels) overlap.
<!--/shortDescription-->
