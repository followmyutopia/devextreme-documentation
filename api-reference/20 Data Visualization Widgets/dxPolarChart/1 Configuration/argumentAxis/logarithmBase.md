<!--id-->dxPolarChart.Options.argumentAxis.logarithmBase<!--/id-->
===========================================================================
<!--default-->10<!--/default-->
<!--type-->Number<!--/type-->
===========================================================================
...
<!--shortDescription-->
Specifies the value to be raised to a power when generating ticks for a [logarithmic axis](/Documentation/ApiReference/Data_Visualization_Widgets/dxPolarChart/Configuration/argumentAxis/#type).
<!--/shortDescription-->
