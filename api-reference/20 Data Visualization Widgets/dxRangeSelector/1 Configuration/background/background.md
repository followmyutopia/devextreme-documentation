...
---
A background is an area that is painted in a specified color. You can change this color by setting the background's **color** property and by displaying an image specified by the [image](/api-reference/20%20Data%20Visualization%20Widgets/dxRangeSelector/1%20Configuration/background/image/image.md '/Documentation/ApiReference/Data_Visualization_Widgets/dxRangeSelector/Configuration/background/image/') configuration object. In addition, you can superimpose a chart on a background by specifying the [chart](/api-reference/20%20Data%20Visualization%20Widgets/dxRangeSelector/1%20Configuration/chart/chart.md '/Documentation/ApiReference/Data_Visualization_Widgets/dxRangeSelector/Configuration/chart/') configuration object. The chart will be shown with the specified background color. To show the chart without a background, set the background's **visible** property to **false**.
