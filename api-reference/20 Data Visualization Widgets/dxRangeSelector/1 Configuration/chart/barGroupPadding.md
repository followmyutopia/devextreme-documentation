---
id: dxRangeSelector.Options.chart.barGroupPadding
type: Number
default: 0.3
---
---
##### shortDescription
Controls the padding and consequently the width of a group of bars with the same argument using relative units. Ignored if the [barGroupWidth](/Documentation/ApiReference/Data_Visualization_Widgets/dxRangeSelector/Configuration/chart/#barGroupWidth) option is set.
