    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>The <i>value</i> with an applied <a href="/Documentation/17_1/ApiReference/Data_Visualization_Widgets/dxChart/Series_Types/BubbleSeries/label/#format">format</a> and converted to string.</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>The <i>argument</i> with an applied <a href="/Documentation/17_1/ApiReference/Data_Visualization_Widgets/dxChart/Series_Types/BubbleSeries/label/#argumentFormat">format</a> and converted to string.</td>
            </tr>
            <tr>
                <td style="text-align:left">size</td>
                <td>The size value of the point.</td>
            </tr>
            <tr>
