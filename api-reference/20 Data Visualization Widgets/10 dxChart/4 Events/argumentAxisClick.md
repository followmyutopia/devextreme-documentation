...
<!--fp1_field4d-->The axis argument that was actually clicked.<!--/fp1_field4d-->
===========================================================================

<!--shortDescription-->
Fires when a user clicks a [label](/Documentation/Guide/Data_Visualization/Charts/Chart_Elements/#Axis_Labels) on the [argument axis](/Documentation/Guide/Data_Visualization/Charts/Chart_Elements/#Axes/Argument_Axis).
<!--/shortDescription-->
...
The jQuery event.
<!--/typeFunctionParamDescription1_field3-->
<!--typeFunctionParamName1_field4-->argument<!--/typeFunctionParamName1_field4-->
<!--typeFunctionParamType1_field4-->Date|Number|string<!--/typeFunctionParamType1_field4-->
