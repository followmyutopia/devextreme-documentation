<!--id-->dxChartSeriesTypes.StackedBarSeries.selectionMode<!--/id-->
===========================================================================
...
<div class="simple-table">
    <table>
        ...
        <tbody>
            <tr>
                <td><i>"onlyPoint"</i></td>
                <td><img src="/Content/images/doc/19_1/ChartJS/hoverMode/series/stackedbar/onlyPoint.png" /></td>
            </tr>
            <tr>
                <td><i>"allSeriesPoints"</i></td>
                <td><img src="/Content/images/doc/19_1/ChartJS/hoverMode/series/stackedbar/allSeriesPoints.png" /></td>
            </tr>
            <tr>
                <td><i>"allArgumentPoints"</i></td>
                <td><img src="/Content/images/doc/19_1/ChartJS/hoverMode/series/stackedbar/allArgumentPoints.png" /></td>
            </tr>
            <tr>
                <td><i>"none"</i></td>
                <td><img src="/Content/images/doc/19_1/ChartJS/hoverMode/series/stackedbar/none.png" /></td>
            </tr>
        </tbody>
    </table>
</div>
...
- **series**.[selectionStyle](/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Series_Types/StackedBarSeries/selectionStyle/) - specifies the appearance of bars in the selected state.
