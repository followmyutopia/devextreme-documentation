<!--id-->dxChartSeriesTypes.StepLineSeries.label.customizeText<!--/id-->
===========================================================================
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>The <i>value</i> with an applied <a href="/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Series_Types/StepLineSeries/label/#format">format</a> and converted to string.</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>The <i>argument</i> with an applied <a href="/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Series_Types/StepLineSeries/label/#argumentFormat">format</a> and converted to string.</td>
            </tr>
            <tr>
