<!--id-->dxChartSeriesTypes.CommonSeries.argumentField<!--/id-->
===========================================================================
...
[note]Certain series types have more than one value field, or require additional data fields to be set. Refer to the [valueField](/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Configuration/series/#valueField) option description for details.
