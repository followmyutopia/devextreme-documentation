...
---
[note]When this option is set to **true**, some series points may still be hidden because of the [autoHidePointMarkers](/Documentation/ApiReference/Data_Visualization_Widgets/dxChart/Configuration/#autoHidePointMarkers) option.