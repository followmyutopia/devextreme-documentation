<!--id-->dxPieChart.Options.seriesTemplate<!--/id-->
===========================================================================
...
<!--fullDescription-->
In most cases, you can organize the array that is assigned to the chart's [dataSource](/Documentation/ApiReference/Data_Visualization_Widgets/dxPieChart/Configuration/#dataSource) option in the following way.
